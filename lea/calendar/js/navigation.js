 ...
 * @version $Id: navigation.js 53844 2015-10-06 15:56:27Z hnategh $
 */
...
(function()
{
	...
	egw_LAB.wait(function() {
		$j(function(){
			...
			// SPIREA-YLF - Submit lors de la sélection d'un site
			$j('#calendar_merge,#calendar_filter,#calendar_cat_id,#calendar_test,#calendar_site').change(function(){
