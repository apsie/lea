 ...
 * @version $Id: tables_update.inc.php 54226 2015-11-10 10:58:13Z ralfbecker $
 */
...
function calendar_upgrade14_3_002()
{
	...
	/* done by RefreshTable() anyway
	$GLOBALS['egw_setup']->oProc->AddColumn('egw_cal','cal_site',array(
		'type' => 'int',
		'precision' => '4'
	));*/
	$GLOBALS['egw_setup']->oProc->RefreshTable('egw_cal',array(
		'fd' => array(
			...
			'cal_uid' => array('type' => 'varchar','precision' => '128','nullable' => False,'comment' => 'unique id of event(-series)'),
			...
			'tz_id' => array('type' => 'int','precision' => '4','comment' => 'key into egw_cal_timezones'),
			'cal_deleted' => array('type' => 'int','precision' => '8','comment' => 'ts when event was deleted'),
			'caldav_name' => array('type' => 'varchar','precision' => '128','comment' => 'name part of CalDAV URL, if specified by client'),
			...
			'cal_site' => array('type' => 'int','precision' => '4')
		),
		'pk' => array('cal_id'),
		'fk' => array('cal_site' => 'spireapi_site'),
		'ix' => array('cal_uid','cal_owner','cal_modified','cal_reference','cal_deleted','caldav_name'),
		'uc' => array()
	));

	return $GLOBALS['setup_info']['calendar']['currentver'] = '14.3.003';
}
