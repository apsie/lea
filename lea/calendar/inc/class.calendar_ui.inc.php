 ...
 * @version $Id: class.calendar_ui.inc.php 53867 2015-10-07 12:04:18Z ralfbecker $
 */
...
class calendar_ui
{
	...
	function __construct($use_boupdate=false,$set_states=NULL)
	{
		...
		//Spirea-YLF
		$this->site = isset($_GET['site']) ? $_GET['site'] : $this->site;
	...
	*/
	...
	function sidebox_menu()
	{
		...
		//Spirea-YLF - Liste des sites
		$site = CreateObject('spireapi.site_bo');
		$file[++$n] = $this->_select_box('Sites','site',$site->formatted_list($this->site));
		// Fin spirea
