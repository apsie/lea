	...
	*/
		...
		if ($GLOBALS['egw_info']['user']['apps']['spisession'] && $location != 'admin' && $location != 'preferences'){
			...
			if(spisession_so::is_manager()){
				...
				// 	'link' => false,
				// );
				$file['New course'] = "javascript:egw_openWindowCentered2('".egw::link('/index.php',array('menuaction' => 'spisession.course_ui.edit'),false)."','_blank',990,600,'yes')";
			}
		...
		if ($GLOBALS['egw_info']['user']['apps']['spisession'] && $location != 'admin' && $location != 'preferences'){
			...
			if(spisession_so::is_manager()){
				...
				// 	'link' => false,
				// );
				$file['New session'] = "javascript:egw_openWindowCentered2('".egw::link('/index.php',array('menuaction' => 'spisession.spisession_ui.edit'),false)."','_blank',990,600,'yes')";
			}
		...
		if ($GLOBALS['egw_info']['user']['apps']['spisession'] && $location != 'admin'){
			...
			if ($GLOBALS['egw_info']['user']['SpiSessionLevel'] > 50){
				...
				// 		'link' => false,
				// 	);
				$file['New session date'] = "javascript:egw_openWindowCentered2('".egw::link('/index.php',array('menuaction' => 'spisession.date_ui.edit'),false)."','_blank',990,600,'yes')";
			};
		...
		if ($GLOBALS['egw_info']['user']['apps']['spisession'] && $location != 'admin' && $location != 'statistics'){
			$file = array();
			$file['Registrations']=$GLOBALS['egw']->link('/index.php','menuaction=spisession.regis_ui.index');
		...
		if ($GLOBALS['egw_info']['user']['apps']['admin'] && $location != 'preferences' && $location != 'admin'){
			...
			$file['General']=$GLOBALS['egw']->link('/index.php','menuaction=spisession.spisession_ui.admin');
