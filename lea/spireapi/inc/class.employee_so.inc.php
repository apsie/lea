...
class employee_so extends so_sql{
	...
	function employee_so(){
		...
		$this->so_resource = new so_sql('resources', 'egw_resources');
	}
	...
	function id2field($so_, $id, $field){
	/**
	 * Retourne la valeur du champ $field de l'objet $id dans la table $so_
	 *
	 * @param $so_ : objet so_sql pointant sur une table
	 * @param $id : identifiant de l'objet dans la table
	 * @param $field : label du champ a retourné
	 * @return 
	 */
		$obj = $so_->read($id);
		return $obj[$field];
