...
class spireapi_hooks
{
	...
	*/
		...
		if (($GLOBALS['egw_info']['user']['apps']['spireapi'] || $GLOBALS['egw_info']['user']['spireapiLevel'] >= 100) && $location != 'admin' && $location != 'referentiel'){
			...
			$file['Book']=$GLOBALS['egw']->link('/index.php','menuaction=spireapi.book_ui.index');
			$file['Accounts']=$GLOBALS['egw']->link('/index.php','menuaction=spireapi.account_ui.index');
		...
		if (($GLOBALS['egw_info']['user']['apps']['spireapi'] || $GLOBALS['egw_info']['user']['spireapiLevel'] >= 100) && $location != 'admin' && $location != 'referentiel'){
			...
			$file['Invoice categories']=$GLOBALS['egw']->link('/index.php','menuaction=spireapi.facture_categories_ui.index');
				
			if ($location == 'invoice'){
				display_section($appname,$file);
			}else{
				display_sidebox($appname,lang('Invoice'),$file);
			}
		}
		...
		if (($GLOBALS['egw_info']['user']['apps']['spireapi'] || $GLOBALS['egw_info']['user']['spireapiLevel'] >= 100) && $location != 'admin' && $location != 'referentiel'){
			...
			$file['Countries']=$GLOBALS['egw']->link('/index.php','menuaction=spireapi.country_ui.index');
