...
function spireapi_upgrade0_011()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_site','site_responsible',array(
		'type' => 'int',
		'precision' => '4'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_site','site_group',array(
		'type' => 'int',
		'precision' => '4'
	));

	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.012';
}


function spireapi_upgrade0_012()
{
	$GLOBALS['egw_setup']->oProc->CreateTable('spireapi_acc_accounts',array(
		'fd' => array(
	...
	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.013';
}


function spireapi_upgrade0_013()
{
	/* done by RefreshTable() anyway
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_vat','vat_account_id',array(
		'type' => 'int',
		'precision' => '4'
	));*/
	$GLOBALS['egw_setup']->oProc->RefreshTable('spireapi_vat',array(
		'fd' => array(
			'vat_id' => array('type' => 'auto','nullable' => False),
			'vat_label' => array('type' => 'varchar','precision' => '255','nullable' => False),
			'vat_rate' => array('type' => 'decimal','precision' => '10','scale' => '2'),
	...
	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.014';
}


function spireapi_upgrade0_014()
{
	$GLOBALS['egw_setup']->oProc->CreateTable('spireapi_acc_book',array(
		'fd' => array(
	...
	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.015';
}


function spireapi_upgrade0_015()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_employee','employee_hiring_date',array(
		'type' => 'int',
		'precision' => '20'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_employee','employee_month_quota',array(
		'type' => 'decimal',
		'precision' => '10',
		'scale' => '2'
	));

	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.016';
}

function spireapi_upgrade0_016()
{
	$GLOBALS['egw_setup']->oProc->CreateTable('spireapi_facture_categories',array(
		'fd' => array(
	...
	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.017';
}


function spireapi_upgrade0_017()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_employee','employee_departure_date',array(
		'type' => 'int',
		'precision' => '20'
	));

	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.018';
}


function spireapi_upgrade0_018()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spireapi_site','site_short',array(
		'type' => 'varchar',
		'precision' => '10'
	));

	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.019';
}


function spireapi_upgrade0_019()
{
	$GLOBALS['egw_setup']->oProc->CreateTable('spireapi_country',array(
		'fd' => array(
	...
	return $GLOBALS['setup_info']['spireapi']['currentver'] = '0.020';
}
