...
*/	
require_once(EGW_INCLUDE_ROOT. '/spiclient/inc/class.delai_paiement_so.inc.php');	
	
class delai_paiement_bo extends delai_paiement_so{
	...
	*/
	...
	function get_info($id){
		...
		* @return string
		*/
		$info = $this->search(array('delai_id'=>$id),false);
		return $info[0];
	}
