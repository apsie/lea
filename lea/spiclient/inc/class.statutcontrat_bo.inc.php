...
*/	
require_once(EGW_INCLUDE_ROOT. '/spiclient/inc/class.statutcontrat_so.inc.php');	
	
class statutcontrat_bo extends statutcontrat_so{
	...
	*/
	...
	function get_info($id){
		...
		* @return string
		*/
		$info=$this->search(array('status_id'=>$id),false);
		return $info[0];
	}
