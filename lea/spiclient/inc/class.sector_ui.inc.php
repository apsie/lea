...
*/
require_once(EGW_INCLUDE_ROOT. '/spiclient/inc/class.sector_bo.inc.php');
	...
	*/
		...
		*/
		...
		if (!is_array($content['nm']))
		{
			...
			$content['nm'] = array(                           // I = value set by the app, 0 = value on return / output
				'get_rows'       	=>	'spiclient.sector_ui.get_rows',	// I  method/callback to request the data for the rows eg. 'notes.bo.get_rows'
		...
		// );
		$content['nm']['template']='spiclient.sector.index.rows';
		$content['nm']['header_right'] = 'spiclient.sector.index.right';
				
		$GLOBALS['egw_info']['flags']['app_header'] = lang('Sector Management');		
		
		$tpl = CreateObject('etemplate.etemplate', 'spiclient.sector.index');
		$tpl->exec('spiclient.sector_ui.index', $content,$sel_options,$no_button, $content);
	}
	...
	function edit($content=null){
		...
		*/
		...
		$tpl = CreateObject('etemplate.etemplate', 'spiclient.sector.edit');
		$tpl->exec('spiclient.sector_ui.edit', $content,$sel_options,$readonlys,$content,2);
	}
	...
	function view(){
		...
		*/
		if(isset($_GET['id'])){
			...
			$GLOBALS['egw']->redirect_link('/index.php','menuaction=spiclient.sector_ui.index');
		}
		...
		$tpl = CreateObject('etemplate.etemplate', 'spiclient.sector.edit');
		$tpl->exec('spiclient.sector_ui.view', $content,$sel_options,$readonlys,$content,2);
	}
