...
class nature_so extends so_sql{
	...
	function __construct(){
		...
		*/
		...
		parent::__construct('spiclient',$this->spiclient_nature,null,'',true);
	}
	 ...
	 * @return string
	 */
		$name = $this->read(array('nature_id' => $id),'nature_label');
		return $name['nature_label'];
	}
}
