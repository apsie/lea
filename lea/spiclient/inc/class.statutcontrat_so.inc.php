...
class statutcontrat_so extends so_sql{
	...
	function __construct(){
		...
		*/
		...
		parent::__construct('spiclient',$this->spiclient_statut_contrat,null,'',true);
	 ...
	 * @return array
	 */
		$parent=$this->search('','status_id,status_label');
		$parents=array();
		$parents['']='All';
		if(!empty($parent)){
