...
tab_cat['0']['cat_id'] = "20";
tab_cat['0']['cat_managementgroup'] = "-9";
tab_cat['0']['cat_assignedto'] = "7";
tab_cat['0']['parent'] = "0";
tab_cat['0']['possible_select'] = "1";
tab_cat['0']['group_user'] = "-9,-5,-6";
tab_cat['1'] = new Object();
tab_cat['1']['cat_id'] = "21";
tab_cat['1']['cat_managementgroup'] = "-9";
tab_cat['1']['cat_assignedto'] = "7";
tab_cat['1']['parent'] = "20";
tab_cat['1']['possible_select'] = "1";
tab_cat['1']['group_user'] = "-9,-5,-6";
tab_cat['2'] = new Object();
tab_cat['2']['cat_id'] = "22";
tab_cat['2']['cat_managementgroup'] = "-9";
tab_cat['2']['cat_assignedto'] = "7";
tab_cat['2']['parent'] = "20";
tab_cat['2']['possible_select'] = "1";
tab_cat['2']['group_user'] = "-9,-5,-6";
tab_cat['3'] = new Object();
tab_cat['3']['cat_id'] = "23";
tab_cat['3']['cat_managementgroup'] = "-9";
tab_cat['3']['cat_assignedto'] = "7";
tab_cat['3']['parent'] = "0";
tab_cat['3']['possible_select'] = "1";
tab_cat['3']['group_user'] = "-9,-5,-6";
...
groupeClients['-10']['8'] = "demandeur demandeur";
groupeClients['-6'] = new Object();
groupeClients['-6']['7'] = "Yann Le Frioux";
groupeClients['-5'] = new Object();
groupeClients['-5']['7'] = "Yann Le Frioux";

				//Tableau des membrerGroupesDuUser
				membrerGroupesDuUser = new Object();
membrerGroupesDuUser['-9'] = new Object();
membrerGroupesDuUser['-9']['7'] = "administrateur";
membrerGroupesDuUser['-6'] = new Object();
membrerGroupesDuUser['-6']['7'] = "administrateur";
membrerGroupesDuUser['-5'] = new Object();
membrerGroupesDuUser['-5']['7'] = "administrateur";
membrerGroupesDuUser['-5']['11'] = "test";

				//Tableau des tabDefault
				tabDefault = new Object();
tabDefault['assigned_to_id'] = "7";
tabDefault['7'] = "administrateur";
tabDefault['group_management_id'] = "-9";
tabDefault['group_management_value'] = "GESTIONNAIRES";
tabDefault['group_management_value_users'] = new Object();
tabDefault['group_management_value_users']['7'] = "administrateur";
tabDefault['demandeur'] = new Object();
tabDefault['demandeur']['7'] = "administrateur";

				//Tableau des groupesDuUser
				groupesDuUser = new Object();
groupesDuUser['-9'] = "GESTIONNAIRES";
groupesDuUser['-5'] = "Default";
groupesDuUser['-6'] = "Admins";
