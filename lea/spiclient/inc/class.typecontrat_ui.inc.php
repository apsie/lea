...
*/
require_once(EGW_INCLUDE_ROOT. '/spiclient/inc/class.typecontrat_bo.inc.php');	
require_once(EGW_INCLUDE_ROOT. '/spiclient/inc/class.acl_spiclient.inc.php');	

class typecontrat_ui extends typecontrat_bo
{
	...
	*/
		...
		{
			$default_cols='type_id,type_label,type_description';
			$content['nm'] = array(                           // I = value set by the app, 0 = value on return / output
				'get_rows'       	=>	'spiclient.typecontrat_ui.get_rows',	// I  method/callback to request the data for the rows eg. 'notes.bo.get_rows'
		...
		$content['nm']['template']='spiclient.typecontrat.index.rows';
		if(!isset($_GET['view'])){
			$content['nm']['header_right'] = 'spiclient.typecontrat.index.right';
		}
		$GLOBALS['egw_info']['flags']['app_header'] = lang('Contract type Management');	
		
		$tpl = CreateObject('etemplate.etemplate', 'spiclient.typecontrat.index');
		$tpl->exec('spiclient.typecontrat_ui.index', $content,$sel_options,$no_button, $content);
	}
	...
	*/
		...
		$tpl = CreateObject('etemplate.etemplate', 'spiclient.typecontrat.edit');
		$tpl->exec('spiclient.typecontrat_ui.edit', $content,$sel_options,$readonlys,$content,2);
	}
	...
	*/
		if(isset($_GET['id'])){
			...
			$GLOBALS['egw']->redirect_link('/index.php','menuaction=spiclient.typecontrat_ui.index');
		}
		...
		$tpl = CreateObject('etemplate.etemplate', 'spiclient.typecontrat.edit');
		$tpl->exec('spiclient.typecontrat_ui.view', $content,$sel_options,$readonlys,$content,2);
	}
