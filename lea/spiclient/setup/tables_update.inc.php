...
function spiclient_upgrade1_032()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spiclient','client_external_id',array(
		'type' => 'int',
		'precision' => '4'
	));

	return $GLOBALS['setup_info']['spiclient']['currentver'] = '1.033';
}
