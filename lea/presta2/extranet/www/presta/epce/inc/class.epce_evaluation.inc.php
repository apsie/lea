...
$requete='SELECT * FROM  egw_prestation where id_ben='.$id_beneficiaire.'';
		...
		$resultat = mysql_query($requete) or die(mysql_error());
			$requete2='SELECT * FROM  egw_epce_forme_juridique where id_beneficiaire='.$id_beneficiaire.'';
...
$pt_fort=addslashes($pt_fort);
	...
	function verif_beneficiaire_plan_eval($id_beneficiaire, $descrip_proj, $etat_proj, $pt_a_evaluer, $pt_a_evaluer2, $pt_a_evaluer3, $attente_benef,$attente_benef2,$attente_benef3, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$id_presta)
		...
		$this->update_plan_eval($id_beneficiaire, $descrip_proj_, $etat_proj_, $pt_a_evaluer_, $attente_benef_, $comment_ref_, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$pt_a_evaluer2_,$pt_a_evaluer3_,$attente_benef2_,$attente_benef3_,$id_presta);	
		return 'none';
		}	
