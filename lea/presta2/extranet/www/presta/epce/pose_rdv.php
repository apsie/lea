...
<body><form style="padding-left:50px;" action="pose_rdv.php" method="get" >
  ...
  for($i=0;$i<count($lieus);$i++)
  {
  	echo'<option value="'.$lieus[$i]['id_lieu'].'">'.$lieus[$i]['nom_lieu'].'</option>';
