 ...
 <div style="display:block; border:2px solid #000; background-color:#D3FEC5"  id="coherence_hp">
    ...
    <h3>Formation, competences et capacites du porteur de projet</h3><br>
       ...
       <center> <table width="537" cellpadding="0" cellspacing="0" class="tableGen">
              ...
              <tr>
                <td valign="top" class="td1 table1Col1"><input  type="text" name="exp_pro" onchange="voir_select('exp_pro2'); "  size="45" value="<?php echo $v_hp[0];?>" />
                  <br/><input style="display:none" size="45" onchange="voir_select('exp_pro3')" type="text" id="exp_pro2" name="exp_pro2" value="<?php echo $v_hp[1];?>" /><input style="display:none" size="45" onchange="voir_select('exp_pro4')" type="text" id="exp_pro3" name="exp_pro3" value="<?php echo $v_hp[2];?>"  /><input style="display:none" size="45" type="text" name="exp_pro4" id="exp_pro4" onchange="voir_select('exp_pro5')" value="<?php echo $v_hp[3];?>" /><input style="display:none" size="45" type="text" name="exp_pro5" id="exp_pro5" onchange="voir_select('exp_pro6')" value="<?php echo $v_hp[4];?>"  /><input style="display:none" size="45" type="text" name="exp_pro6" id="exp_pro6" value="<?php echo $v_hp[5];?>"  /><br/>
              
                </td><td><td></a></td>
             <td valign="top"  class="td1 table1Col2">
             <select onchange="voir_select('comp_pro2'); afficherAutre(this.name,comp_proa.name);" id="comp_pro"  name="comp_pro"><option value="<?php echo $v_hp[6];?>"> <?php echo $v_hp[6];?></option><?php $epce->texte('Competences professionnelles'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select>  <input type="text" size="55" style="display:none"  name="comp_proa"  id="comp_proa"/> <select onchange="voir_select('comp_pro3');afficherAutre(this.name,comp_pro2a.name)" style="display:none" id="comp_pro2" name="comp_pro2"><option value="<?php echo $v_hp[7];?>"> <?php echo $v_hp[7];?></option><?php $epce->texte('Competences professionnelles'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="comp_pro2a"  id="comp_pro2a"/><select onchange="voir_select('comp_pro4');afficherAutre(this.name,comp_pro3a.name)" style="display:none"  id="comp_pro3" name="comp_pro3"><option value="<?php echo $v_hp[8];?>"> <?php echo $v_hp[8];?></option><?php $epce->texte('Competences professionnelles'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="comp_pro3a"  id="comp_pro3a"/>
                  <select onchange="voir_select('comp_pro5');afficherAutre(this.name,comp_pro4a.name)" style="display:none" id="comp_pro4" name="comp_pro4"><option value="<?php echo $v_hp[9];?>"> <?php echo $v_hp[9];?></option><?php $epce->texte('Competences professionnelles'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="comp_pro4a"  id="comp_pro4a"/><select onchange="voir_select('comp_pro6');afficherAutre(this.name,comp_pro5a.name);" style="display:none" id="comp_pro5" name="comp_pro5"><option value="<?php echo $v_hp[10];?>"> <?php echo $v_hp[10];?></option><?php $epce->texte('Competences professionnelles'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="comp_pro5a"  id="comp_pro5a"/><select onchange="afficherAutre(this.name,comp_pro6a.name);" style="display:none" id="comp_pro6" name="comp_pro6"><option value="<?php echo $v_hp[11];?>"> <?php echo $v_hp[11];?></option><?php $epce->texte('Competences professionnelles'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="comp_pro6a"  id="comp_pro6a"/></td>
              <td valign="top"  class="tdFin table1Col3"><select  id="form_savoir" onchange="voir_select('form_savoir2');afficherAutre(this.name,form_savoira.name);" name="form_savoir"><option value="<?php echo $v_hp[12];?>"> <?php echo $v_hp[12];?></option><?php $epce->texte('Formation et savoirs theoriques'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="form_savoira"  id="form_savoira"/>  <select style="display:none" onchange="voir_select('form_savoir3');afficherAutre(this.name,form_savoir2a.name);" id="form_savoir2" name="form_savoir2"><option value="<?php echo $v_hp[13];?>"> <?php echo $v_hp[13];?></option><?php $epce->texte('Formation et savoirs theoriques'); ?><option style="color:#F00; font-weight:bolder" value="Autre">Autre</option></select><input type="text" size="55" style="display:none"  name="form_savoir2a"  id="form_savoir2a"/> 
                <select style="display:none" onchange="voir_select('form_savoir4');afficherAutre(this.name,form_savoir3a.name);" id="form_savoir3" name="form_savoir3">
                  <option value="<?php echo $v_hp[14];?>"> <?php echo $v_hp[14];?></option>
...
attendu
 ...
 <h3>Diagnostic et commentaires du referent</h3><br>
 <center>
   <textarea name="diag_commercial" rows="5" cols="125" id="diag_commercial" class="commentaire"><?php echo $v_co[20];?></textarea>
 </center>
