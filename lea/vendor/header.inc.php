...
define('EGW_SERVER_ROOT','/var/www/clients/client1/web4/web/egw_apsie_143/lea');
...
$GLOBALS['egw_info']['server']['header_admin_user'] = 'egwadmin';
$GLOBALS['egw_info']['server']['header_admin_password'] = '{crypt}$2a$12$mcih8xCjr5W9nNLCXsqXA.NACfo8IjIbkY14dMjsKsmf4Co35M716';
...
$GLOBALS['egw_domain']['default'] = array(
	'db_host' => 'localhost',
	'db_port' => '3306',
	'db_name' => 'egw_apsie143',
	'db_user' => 'egw_apsie',
	'db_pass' => 'APS12/APS12',
	// Look at the README file
	'db_type' => 'mysqli',
	// This will limit who is allowed to make configuration modifications
	'config_user'   => 'egwadmin',
	'config_passwd' => '{crypt}$2a$12$rEpqXZKhHYBYiiQt91BN5.CxWtCxSmsjUMWqUmJzLAPlFvZ2zdSdq'
);
...
*/
$GLOBALS['egw_info']['server']['mcrypt_iv'] = 'HHToqJbSMLuZ9Pcum7baZ57RBTFyU';
