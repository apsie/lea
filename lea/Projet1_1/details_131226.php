...
function voirdiv(nomdiv,nomdiv2,nomdiv3,nomdiv4,nomdiv5,nomdiv6,nomdiv7)
	...
	*/
	...
	if(selectElmt.options[selectElmt.selectedIndex].value==114)
	{
		...
		document.getElementById('intitule_compte_ressource').options[4].text=null;
	document.getElementById('intitule_compte_ressource').options[5].text=null;
	document.getElementById('intitule_compte_ressource').options[6].text=null;
	document.getElementById('intitule_compte_ressource').options[7].text=null;
	document.getElementById('intitule_compte_ressource').options[8].text=null;
	document.getElementById('intitule_compte_ressource').options[9].text=null;
	document.getElementById('intitule_compte_ressource').options[10].text=null;
	}
	...
	document.getElementById('intitule_compte_ressource').options[2].text=null;
	document.getElementById('intitule_compte_ressource').options[3].text=null;
	document.getElementById('intitule_compte_ressource').options[4].text=null;
	document.getElementById('intitule_compte_ressource').options[5].text=null;
	document.getElementById('intitule_compte_ressource').options[6].text=null;
	document.getElementById('intitule_compte_ressource').options[7].text=null;
...
<table bgcolor="#ebe8e4" border="0" cellpadding="0" cellspacing="0">
   ...
   <td width="1313"><center><input value="Retour" onClick="window.location.href='index.php?domain=default'" type="button"></center></td>
      		
      </tr>
     
    </tbody></table><center><h2>PROJET : <?php echo $val_projet[0]; ?></h2></center><div><table style="border:1px solid #CCC"><tr><td bgcolor="#EBF2FE"><a href="javascript:voirdiv('projet','projet_creation','investissement','financement','charge','produit','effectif');" >Le projet</a> </td><td>|</td>
    <td> <a href="javascript:voirdiv('projet_creation','projet','investissement','financement','charge','produit','effectif');" >Information sur l'organisation</a></td><td>|</td><td> <a href="javascript:voirdiv('investissement','projet','projet_creation','financement','charge','produit','effectif');" >Investissement</a></td><td>|</td><td> <a  href="javascript:voirdiv('financement','investissement','projet','projet_creation','charge','produit','effectif');" >Financement</a></td><td>|</td><td> <a  href="javascript:voirdiv('charge','financement','investissement','projet','projet_creation','produit','effectif');" >Charges</a></td><td>|</td><td><a  href="javascript:voirdiv('produit','projet_creation','financement','investissement','projet','charge','effectif');" >Produits</a></td><td>|</td><td><a  href="javascript:voirdiv('effectif','produit','projet_creation','financement','investissement','projet','charge');" >Effectifs</a></td></tr></table><div id="projet"><form method="post"><table style="border:1px solid #CCC" ><tr bgcolor='#ECF3F4'  ><input name="id_projet" type="hidden" value="<?php echo $_GET['id_projet'] ;?>" />
          <td width="300">Intitul&eacute; du projet</td><td width="818" ><?php echo $val_projet[0]; ?></td><td width="172"></td></tr><tr bgcolor='#FFF'>
        <td>Date de d&eacute;but</td>
        <td ><?php echo $val_projet[5]; ?></td><td></td></tr><tr bgcolor='#ECF3F4'>
        <td>Date de fin pr&eacute;visionnelle</td>
        <td ><input id="date_fin_pre_projet" name="date_fin_pre_projet" type="text" value="<?php echo $val_projet[7]; ?>"> <script type="text/javascript">

	document.writeln('<img id="date_fin_pre_projet-trigger" src="index.php_fichiers/datepopup.gif" title="Selectionner la date" style="cursor:pointer; cursor:hand;"/>');
	Calendar.setup(
	{
...
</script></td><td></td></tr><tr bgcolor='#FFF'>
        <td>Date de fin r&eacute;elle</td>
        <td ><input id="date_fin_projet" name="date_fin_projet" type="text" value="<?php echo $val_projet[6]; ?>">  <script type="text/javascript">

	document.writeln('<img id="date_fin_projet-trigger" src="index.php_fichiers/datepopup.gif" title="Selectionner la date" style="cursor:pointer; cursor:hand;"/>');
	Calendar.setup(
	{
...
</script></td><td></td></tr><tr bgcolor='#ECF3F4' ><td>Coordinateur</td><td ><?php $projet->selectionner_conseiller3($val_projet[1]) ?></td><td></td></tr><tr bgcolor='#FFF'  ><td>Description du projet</td><td ><textarea name="description_projet" style="font-size:11px; border:1px solid #CCC; color: #069;" rows="5" cols="100"><?php echo $val_projet[2]; ?></textarea></td><td></td></tr><tr bgcolor='#ECF3F4'>
        <td>Statut</td><td ><select name="statut_projet"><option><?php echo $val_projet[3]; ?></option><option>Abandon</option><option>Complet</option><option>En cours</option><option>Suspendu</option></select></td><td></td></tr><tr bgcolor='#FFF' >
          <td>R&eacute;sultat</td><td ><select name="resultat_projet"><option><?php echo $val_projet[4]; ?></option><option>En attente de resultat</option><option>Entreprise Cree</option><option>Retour à l'emploi</option></select></td><td></td></tr><tr bgcolor='#ECF3F4'>
       <td>&nbsp;</td><td ><input type="submit" name="enregistrer_projet" value="Enregistrer" /></td><td>&nbsp;</td></tr></table></form></div>
            
           <div style="display:none" id="projet_creation">
            <form method="get"> <input type="hidden"  value="default" name="domain" /><input type="hidden" name="id_projet" value="<?php echo $_GET['id_projet']; ?>" /><table style="border:1px solid #CCC" width="1181"><tr bgcolor="#EBF2FE">
      <td width="193">Nom commercial</td>
      <td width="302" ><input size="50" type="text" name="nom_commercial" value="<?php echo $retour_org_ben[0]; ?>" /></td><td></td><td></td></tr><tr bgcolor="#FFF">
      <td>Raison social</td>
      <td width="302" ><input size="50" type="text" name="raison_sociale" value="<?php echo $retour_org_ben[1]; ?>" /> </td><td width="136">
        Siret</td><td> 
          <input type="text" value="<?php echo $retour_org_ben[14]; ?>" name="siret" /> </td></tr><tr bgcolor="#EBF2FE">
      <td >Activit&eacute; principale</td>
      <td width="302" ><input size="50" type="text" name="activite_principale" value="<?php echo $retour_org_ben[2]; ?>" /></td>
      <td>Code naf</td><td><input  onblur="fill_naf();" onKeyUp="lookup_naf(this.value);"  name="code_naf" id="code_naf" type="text" value="<?php echo $retour_org_ben[23]; ?>" /><div class="suggestionsBox" id="suggestions_naf" style="display: none;"> <img src="upArrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
        <div class="suggestionList" id="autoSuggestionsList_naf"> &nbsp; </div></div> </td></tr><tr bgcolor="#FFF">
      <td>Date immat</td>
      <td width="302" ><input name="date_immat"  type="text" value="<?php if($retour_org_ben[11]!=0) echo date("d/m/Y",$retour_org_ben[11]); ?>"  id="date_immat"/> <script type="text/javascript">
	...
	Calendar.setup(
	{
      ...
      <td width="530" ><input name="date_debut_activite"  type="text" value="<?php if($retour_org_ben[12]!=0) echo date("d/m/Y",$retour_org_ben[12]); ?>" id="date_debut_activite" /> <script type="text/javascript">
	...
	Calendar.setup(
	{
      ...
      <td><hr /></td>
      <td width="302" ><hr /></td> <td ><hr /></td><td ><hr /></td></tr><tr bgcolor="#EBF2FE">
      <td>Type d'adresse</td>
      <td width="302"><select name="type_adresse" style="width:160px"><option value="<?php echo  $retour_org_ben[3]; ?>"><?php echo  $retour_org_ben[3]; ?></option><?php $projet->texte('type_adresse');?></select></td><td></td><td></td></tr><tr bgcolor="#FFF">
      <td>Rue </td><td> <input size="50" name="adresse_ligne_1" type="text" value="<?php echo  $retour_org_ben[4]; ?>" /></td><td></td><td></td></tr><tr bgcolor="#EBF2FE">
	      <td>Adresse ligne 2</td><td><input name="adresse_ligne_2" size="50" type="text" value="<?php echo $retour_org_ben[5]; ?>" /></td><td></td><td></td></tr><tr bgcolor="#FFF">
	        <td>Adressse ligne 3</td><td><input name="adresse_ligne_3" size="50" type="text" value="<?php echo  $retour_org_ben[6]; ?>" /></td><td></td><td></td></tr><tr bgcolor="#EBF2FE">
	        <td><div class="suggestionsBox" id="suggestions" style="display: none;"> <img src="upArrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
        <div class="suggestionList" id="autoSuggestionsList"> &nbsp; </div>
      </div>Code postal</td><td><input onBlur="fill();" autocomplete="off" id="cp" onKeyUp="lookup(this.value,'cp');"  name="cp" type="text" value="<?php echo $retour_org_ben[7]; ?>" /></td><td></td><td></td></tr><tr bgcolor="#FFF">
	          <td>Ville</td>
	            <td><input type="text" id="ville" name="ville"  value="<?php echo $retour_org_ben[8]; ?>" /></td><td></td><td></td></tr><tr bgcolor="#EBF2FE">
                 <td>Region</td><td><input name="region" id="region"  type="text" value="<?php echo $retour_org_ben[9]; ?>" /></td><td></td><td></td></tr>
	        <tr bgcolor="#FFF"><td>Pays</td><td><input name="pays" id="pays" type="text" value="<?php echo $retour_org_ben[10]; ?>" /></td><td></td><td></td></tr><tr><td><hr /></td><td><hr /></td> <td  ><hr /></td><td ><hr /></td></tr><tr bgcolor="#EBF2FE">
      <td>Dirigeant</td>
      <td width="302" style="font-weight:bolder"><select name="dirigeant" style="width:160px"><option value="<?php echo  $retour_org_ben[16]; ?>" ><?php echo $retour_org_ben[16]; ?></option><option value="Le beneficiaire">Le beneficiaire</option> <option value="L'Associe">L'Associe</option></select></td><td></td><td></td></tr><tr bgcolor="#FFF">
      <td>Forme juridique</td>
      <td width="302" style="font-weight:bolder"><select name="forme_juridique" style="width:160px"><option value="<?php echo $retour_org_ben[13]; ?>" ><?php echo $retour_org_ben[13]; ?></option><?php $projet->texte('forme_juridique');?></select></td><td></td><td></td></tr><tr bgcolor="#EBF2FE">
      <td>Implantation</td>
      <td width="302" style="font-weight:bolder"><select name="implantation" style="width:160px"><option value="<?php echo  $retour_org_ben[17]; ?>"><?php echo $retour_org_ben[17]; ?></option><?php $projet->texte('Implantation');?></select></td><td></td><td></td></tr><tr bgcolor="#FFF">
      <td>Secteur d'activit&eacute;</td>
      <td width="302" style="font-weight:bolder"><select name="secteur_activite" ><option value="<?php echo $retour_org_ben[15]; ?>"><?php echo $retour_org_ben[15]; ?></option><?php $projet->texte('secteur_activite');?></select></td><td></td><td></td></tr><tr><td ><hr /></td><td><hr /></td><td><hr /></td> <td  ><hr /></td></tr><tr bgcolor="#EBF2FE">
      <td>R&eacute;gime d'impostion</td>
      <td width="302" style="font-weight:bolder"><select name="regime_imposition" style="width:160px"><option value="<?php echo  $retour_org_ben[18]; ?>"><?php echo $retour_org_ben[18]; ?><?php $projet->texte('Regime_imposition');?></option></select></td><td></td><td></td></tr><tr bgcolor="#FFF">
      <td>R&eacute;gime de TVA</td>
      <td width="302" style="font-weight:bolder"><select name="regime_tva" style="width:160px"><option value="<?php echo $retour_org_ben[19]; ?>"><?php echo $retour_org_ben[19]; ?></option><?php $projet->texte('Regime_tva');?></select></td><td></td><td></td></tr><tr bgcolor="#EBF2FE">
      <td>R&eacute;gime fiscal</td>
      <td width="302" style="font-weight:bolder"><select name="regime_fiscal" style="width:160px"> <option value="<?php echo $retour_org_ben[20]; ?>"><?php echo $retour_org_ben[20]; ?></option><?php $projet->texte('regime_fiscal');?></select></td><td></td><td></td></tr><tr><tr bgcolor="#FFF">
      <td>R&eacute;gime social du dirigeant</td>
      <td width="302" style="font-weight:bolder"><select name="regime_social_dirigeant" style="width:160px"><option value="<?php echo $retour_org_ben[21]; ?>"><?php echo $retour_org_ben[21]; ?><?php $projet->texte('Regime_social_dirigeant');?></option></select></td><td></td><td></td></tr><td ><hr /></td><td><hr /></td><td><hr /></td> <td  ><hr /></td></tr><tr><tr bgcolor="#EBF2FE">
      <td>Statut</td>
      <td width="302" style="font-weight:bolder"><select name="statut" style="width:160px"><option value="<?php echo $retour_org_ben[22]; ?>"><?php echo $retour_org_ben[22]; ?></option><option>En cours</option><option>Cree</option><option>Annulee</option></select></td><td></td><td></td></tr><tr bgcolor="#FFF"><td></td><td height="34" align="right">&nbsp;</td><td><input type="submit" name="modifier_org_ben" value="Enregistrer" /></td></td></tr></table></form></div></div>
      
   <div style="display:none" id="investissement"><br/><form method="get"><input type="hidden" name="domain" value="default" /><center><table style="border:1px solid #CCC"  ><tr style="font-weight:bold; background-color: #999; color:#FFF" >
     <td>Exercice</td>
     <input name="id_projet" type="hidden" value="<?php echo $_GET['id_projet'] ;?>" />
          <td >Type immo</td>
          <td  >Intitulé du compte</td>
          <td>Quantit&eacute;</td>  <td >PAU HT</td> <td >Montant HT</td> <td >TVA</td> <td >Montant TVA</td> <td >Montant TTC</td><td></td></tr><?php $projet->voir_investissement($_GET['id_projet']) ;?><tr style="text-align:right;border:1px solid #CCC" bgcolor='#ECF3F4'>
   ...
   <td ><select id="intitule_compte" name="intitule_compte"><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option></select></td><td><input name="quantite"  id="quantite"  onChange="calcul_montant_ht(this.value,document.getElementById('pau_ht').value);" size="1" type="text" /></td><td><input size="4" name="pau_ht" id="pau_ht"  onFocus="calcul_montant_ht(document.getElementById('quantite').value,this.value);" type="text" /></td><td><input size="4" name="montant_ht" onFocus="calcul_montant_ht(document.getElementById('quantite').value,document.getElementById('pau_ht').value);" type="text" id="montant_ht"   /></td><td><select name="tva" onChange="calcultva(document.getElementById('montant_ht').value,this.value);"><option></option><option value="0">0%</option><option value="5.5">5,5%</option><option value="19.6">19,6%</option></select></td><td><div style="color: #F00"  id="div_montant_tva"></div></td><td><div style="color:#090" id="div_montant_ttc"></div></td><td><input name="enregistrer_investissement" type="submit" value="Enregistrer" /></td></tr></table></center></form><br/><center><input type="button" onClick="window.location.href='xls.php?plan_3ans=1&id_projet=<?php echo $_GET['id_projet']; ?>'" value="Voir Plan de financement 3 ans" /></center></div>
   
    <center> <div style="display:none" id="financement"><center></center><br/><form method="get"><input type="hidden" name="domain" value="default" /><table style="border:1px solid #CCC"  ><tr style="font-weight:bold; background-color: #999; color:#FFF" >
      <td width="84" >D&eacute;signation </td>
      <input name="id_projet" type="hidden" value="<?php echo $_GET['id_projet'] ;?>" />
          <td width="84">Exercice</td><td width="109"  >Type Ressource</td>
          <td width="120" >Intitulé du compte</td>
          <td width="93" >Montant pr&eacute;visionnelle</td>
          <td width="86" >Montant Obtenu</td>
          <td width="51"  >Ecart</td>
          <td width="85" >Type Amt</td>
          <td width="75" >Dur&eacute;e</td>
          <td width="60" >Taux</td>
          <td width="64" >Demande</td> 
          <td width="79"></td></tr><?php $projet->voir_financement($_GET['id_projet']) ;?><tr style="text-align:right;border:1px solid #CCC" bgcolor='#ECF3F4'>
        <td><input size="8" type="text" name="designation" /></td>
        <td><select name="exercice"><option>Depart</option><option>Annee 1</option><option>Annee 2</option><option>Annee 3</option></select></td><td><select onChange="return_ressource('ressource');" id="ressource" name="ressource"><option></option><?php $projet->texte('Type ressources','','egw_texte_financement');?></select></td>
   <td ><select id="intitule_compte_ressource" name="intitule_compte_ressource"><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option><option></option></select></td><td><input size="6" id="montant_ressource" name="montant_ressource"  type="text"    /></td>
   <td>&nbsp;</td>
   <td>&nbsp;</td>
   ...
   <td><input style="width:20px" type="text"  name="tx_amt" />
     %</td>
   <td>&nbsp;</td>
   <td><input name="enregistrer_financement" type="submit" value="Enregistrer" /></td></tr></table></form><center><br/><input type="button" onClick="window.location.href='xls.php?plan_3ans=1&id_projet=<?php echo $_GET['id_projet']; ?>'" value="Voir Plan de financement 3 ans" /></center></div></center>
   
   
      <center> <div  style="display:none;"id="produit"><br/><center><strong>Produits</strong></center><br/><form method="get"><input type="hidden" name="domain" value="default" /><table style="border:1px solid #CCC"  ><tr style="font-weight:bold; background-color: #999; color:#FFF" >
        ...
        <td  >Part D&eacute;lai</td>
          ...
          <td  >Annee 1</td><td  >Annee 2</td><td  >Annee 3</td> <td></td></tr><?php $projet->voir_cr3($_GET['id_projet'],'produit') ;?><tr valign="bottom" style="text-align:left;border:1px solid #CCC" bgcolor='#ECF3F4'>
        ...
        <td><input onChange="calcul_annee_suivante(document.getElementById('cr_annee1').value,this.value,document.getElementById('cf_a3').value);" style=" width:25px" id="cf_a2" name="cf_a2"  type="text" value="1" /></td>
        <td><input style=" width:25px" id="cf_a3" name="cf_a3" onChange="calcul_annee_suivante(document.getElementById('cr_annee1').value,document.getElementById('cf_a2').value,this.value);" type="text" value="1" /></td>
        <td><select name="tva_p"><option value="0">0%</option><option value="5.5">5,5%</option><option value="19.6">19,6%</option></select></td>
   ...
   <td><input size="2" name="cr_annee1" id="cr_annee1" onChange="calcul_annee_suivante(this.value,document.getElementById('cf_a2').value,document.getElementById('cf_a3').value);" type="text" /></td><td><div id="div_cr_annee2"></div></td><td><div id="div_cr_annee3"></div></td>
   <td><input type="hidden" name="id_projet" value="<?php echo $_GET['id_projet']; ?>" /><input type="hidden" name="nature" value="produit" /><input name="enregistrer_cr3" type="submit" value="Enregistrer" /></td></tr></table></form><br/><input type="button" onClick="window.location.href='xls.php?cr_3ans=1&id_projet=<?php echo $_GET['id_projet']; ?>'" value="Voir CR 3 ans" /></div></center>
   
    <center> <div style="display:none" id="charge"><br/><center><strong>Charges</strong></center><br/><form id="form_charge" method="get"><input type="hidden" name="domain" value="default" /><table style="border:1px solid #CCC"  ><tr style="font-weight:bold; background-color: #999; color:#FFF" >
        ...
        <td  >Part D&eacute;lai</td>
          ...
          <td  >Annee 2</td>
          <td  >Annee 3</td> 
          <td></td></tr><?php $projet->voir_cr3($_GET['id_projet'],'charge') ;?><tr valign="bottom" style="text-align:left;border:1px solid #CCC" bgcolor='#ECF3F4'>
   ...
   <td><input size="2" name="cr_annee1" id="cr_annee1" onChange="calcul_annee_suivante(this.value,document.getElementById('cf_a2').value,document.getElementById('cf_a3').value);"  type="text" /></td>
   <td><div id="div_cr_annee2_c"></div></td>
   <td><div id="div_cr_annee3_c"></div></td>
   <td><input type="hidden" name="id_projet" value="<?php echo $_GET['id_projet']; ?>" /><input type="hidden" name="nature" value="charge" /><input name="enregistrer_cr3" type="submit" value="Enregistrer" /></td></tr></table></form><br/><input type="button" onClick="window.location.href='xls.php?cr_3ans=1&id_projet=<?php echo $_GET['id_projet']; ?>'" value="Voir CR 3 ans" /></div></center>
   
     <center> <div style="display:none" id="effectif"><br/><center><strong>Effectifs</strong></center><br/><form method="get"><input type="hidden" name="domain" value="default" /><table style="border:1px solid #CCC"  ><tr style="font-weight:bold; background-color: #999; color:#FFF" >
        ...
        <td>Exercice</td>
          ...
          <td  >Statut</td>
          <td  >Nb mois</td>
          <td  >R&eacute;mun. m/brut</td>
          <td  >R&eacute;mun. a/brut</td>
          <td  >Charges sociales TNS</td>
          <td  >Charges patronales TS</td>
          <td  >R&eacute;mun. annuelle</td>
          <td  >Salaire net</td> <td></td></tr><?php $projet->voir_effectif($_GET['id_projet']) ;?><tr valign="bottom" style="text-align:left;border:1px solid #CCC" bgcolor='#ECF3F4'>
   ...
   <td><input name="poste"  type="text" /></td><td><select id="statut"  name="statut" onChange="remun_an(document.getElementById('nb_mois').value,document.getElementById('remun_mens').value,this.value)" >
        <option>Salarié</option><option>Non salarié</option>
        </select></td>
   <td><select id="nb_mois"  onChange="remun_an(this.value,document.getElementById('remun_mens').value,document.getElementById('statut').value)" name="nb_mois"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option>
       <option>9</option><option>10</option> <option>11</option><option selected="selected">12</option>
        </select></td>
   <td><input id="remun_mens" name="remun_mens" onChange="remun_an(document.getElementById('nb_mois').value,this.value,document.getElementById('statut').value)" size="2"  type="text" /></td>
   <td><div  id="div_remun_an_brut"></div></td>
   <td><div  id="div_charges_tns"></div></td>
   <td><div  id="div_charges_ts"></div></td>
   <td><div  id="div_remun_an"></div></td>
   <td><div  id="div_salaire_net"></div></td>
   <td><input type="hidden" name="id_projet" value="<?php echo $_GET['id_projet']; ?>" /><input name="enregistrer_effectif" type="submit" value="Enregistrer" /></td></tr></table></form><br/></div></center>
