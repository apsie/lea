...
tab_cat['0']['name'] = "test";
tab_cat['0']['cat_id'] = "55";
tab_cat['0']['cat_managementgroup'] = "";
tab_cat['0']['cat_assignedto'] = "10";
tab_cat['0']['parent'] = "0";
tab_cat['0']['possible_select'] = "1";
tab_cat['0']['group_user'] = "-11,-9";
...
membrerGroupesDuUser['-11']['12'] = "user.spirea";
membrerGroupesDuUser['-9'] = new Object();
membrerGroupesDuUser['-9']['12'] = "user.spirea";
...
tabDefault['demandeur']['12'] = "user.spirea";

				//Tableau des groupesDuUser
				groupesDuUser = new Object();
groupesDuUser['-11'] = "GRP_TEST";
groupesDuUser['-9'] = "GP-DEMO";
