...
tab_cat['0']['group_user'] = "-22,-23,-21,-20,-1";
...
tab_cat['1']['group_user'] = "-22,-23,-21,-20,-1";
...
tab_cat['2']['group_user'] = "-22,-23,-21,-20,-1";
...
tab_cat['3']['group_user'] = "-22,-23,-21,-20,-1";
tab_cat['4'] = new Object();
tab_cat['4']['name'] = "Contrôle de compteur";
tab_cat['4']['cat_id'] = "45";
tab_cat['4']['cat_managementgroup'] = "-21";
tab_cat['4']['cat_assignedto'] = "14";
tab_cat['4']['parent'] = "37";
tab_cat['4']['possible_select'] = "1";
tab_cat['4']['group_user'] = "-22,-23,-21,-20,-1";
...
groupeClients['-23'] = new Object();
groupeClients['-23']['6'] = "Florent Giacomoni";
groupeClients['-23']['10'] = "Francis Giacomoni";
groupeClients['-23']['15'] = "Stéphane Giacomoni";
groupeClients['-22'] = new Object();
groupeClients['-22']['7'] = "Aurelie Nuckecheddy";
groupeClients['-22']['6'] = "Florent Giacomoni";
groupeClients['-22']['17'] = "Maxime Delaunay";
groupeClients['-22']['18'] = "Narith Lim";
groupeClients['-21'] = new Object();
groupeClients['-21']['24'] = "Anne-Cécile Lamande";
groupeClients['-21']['8'] = "dino Dino";
groupeClients['-21']['6'] = "Florent Giacomoni";
groupeClients['-21']['12'] = "Murat Ulger";
groupeClients['-21']['14'] = "Paula Goncalves";
groupeClients['-20'] = new Object();
groupeClients['-20']['19'] = "Elisabete Loureiro";
groupeClients['-20']['9'] = "Emmanuel Damasio";
groupeClients['-20']['6'] = "Florent Giacomoni";
groupeClients['-20']['11'] = "Ludovic Vahe";
groupeClients['-20']['16'] = "Sylvie Ratel";

				//Tableau des membrerGroupesDuUser
				membrerGroupesDuUser = new Object();
membrerGroupesDuUser['-23'] = new Object();
membrerGroupesDuUser['-23']['6'] = "florent.giacomoni";
membrerGroupesDuUser['-23']['10'] = "francis.giacomoni";
membrerGroupesDuUser['-23']['15'] = "stephane.giacomoni";
membrerGroupesDuUser['-22'] = new Object();
membrerGroupesDuUser['-22']['7'] = "aurelie.nuckecheddy";
membrerGroupesDuUser['-22']['6'] = "florent.giacomoni";
membrerGroupesDuUser['-22']['17'] = "maxime.delaunay";
membrerGroupesDuUser['-22']['18'] = "narith.lim";
membrerGroupesDuUser['-21'] = new Object();
membrerGroupesDuUser['-21']['24'] = "a.lamande";
membrerGroupesDuUser['-21']['8'] = "dino";
membrerGroupesDuUser['-21']['6'] = "florent.giacomoni";
membrerGroupesDuUser['-21']['12'] = "murat.ulger";
membrerGroupesDuUser['-21']['14'] = "paula.goncalves";
...
tabDefault['demandeur']['6'] = "florent.giacomoni";

				//Tableau des groupesDuUser
				groupesDuUser = new Object();
groupesDuUser['-22'] = "MLT-COMMERCIAL";
groupesDuUser['-23'] = "MLT-DIRECTION";
groupesDuUser['-21'] = "MLT-RELEVES";
