...
tab_cat['0']['name'] = "Poste de travail...";
tab_cat['0']['cat_id'] = "39";
tab_cat['0']['cat_managementgroup'] = "-2";
tab_cat['0']['cat_assignedto'] = "10";
tab_cat['0']['parent'] = "0";
tab_cat['0']['possible_select'] = "1";
tab_cat['0']['group_user'] = "-1,-2";
tab_cat['1'] = new Object();
tab_cat['1']['name'] = "test spid";
tab_cat['1']['cat_id'] = "40";
tab_cat['1']['cat_managementgroup'] = "-2";
tab_cat['1']['cat_assignedto'] = "5";
tab_cat['1']['parent'] = "39";
tab_cat['1']['possible_select'] = "1";
tab_cat['1']['group_user'] = "-1,-2";
tab_cat['2'] = new Object();
tab_cat['2']['name'] = "test";
tab_cat['2']['cat_id'] = "55";
tab_cat['2']['cat_managementgroup'] = "";
tab_cat['2']['cat_assignedto'] = "10";
tab_cat['2']['parent'] = "0";
tab_cat['2']['possible_select'] = "1";
tab_cat['2']['group_user'] = "-1,-2";
...
groupeClients['-11']['12'] = "User Spirea";
groupeClients['-9'] = new Object();
groupeClients['-9']['12'] = "User Spirea";
