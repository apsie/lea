...
// Spirea-YLF - 18/07/2012 - Update permettant la maintenance des données suite a l'ajout des champs client_id et ticket_assigned_by_contact
...
function spid_upgrade1_1_061()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_site',array(
		'type' => 'int',
		'precision' => '4'
	));

	return $GLOBALS['setup_info']['spid']['currentver'] = '1.1.062';
}


function spid_upgrade1_1_062()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_invoice_entity',array(
		'type' => 'int',
		'precision' => '4'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_provider',array(
		'type' => 'int',
		'precision' => '4'
	));

	return $GLOBALS['setup_info']['spid']['currentver'] = '1.1.063';
}


function spid_upgrade1_1_063()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_prix_parametres','provider_id',array(
		'type' => 'int',
		'precision' => '4'
	));

	return $GLOBALS['setup_info']['spid']['currentver'] = '1.1.064';
}


function spid_upgrade1_1_064()
{
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_acc_adr_one',array(
		'type' => 'varchar',
		'precision' => '255'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_acc_adr_two',array(
		'type' => 'varchar',
		'precision' => '255'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_acc_adr_postalcode',array(
		'type' => 'varchar',
		'precision' => '5'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_acc_adr_city',array(
		'type' => 'varchar',
		'precision' => '255'
	));
	$GLOBALS['egw_setup']->oProc->AddColumn('spid_tickets','ticket_acc_nb_post',array(
		'type' => 'int',
		'precision' => '4'
	));

	return $GLOBALS['setup_info']['spid']['currentver'] = '1.1.065';
}
