...
class generate_pdf_logo extends fpdf{
	...
	*/
		...
		$this->facture_ui = new facture_ui();
	...
	*/
		...
		$this->Image($GLOBALS['egw_info']['server']['files_dir'].'/altidem.jpg'/*,10,8,38,29*/);
	...
	*/
		...
		$so_clients_relations->so_sql('spid','spid_clients_relations');
