...
class admin_ui extends admin_bo
{
	...
	function index($content=null,$msg=''){	
		...
		*/
		...
		$tpl= new etemplate('spid.admin.index');
		$tpl->exec('spid.admin_ui.index',$content,$sel_options,$readonlys,$content);
	...
	function general($content=null)
	{
		...
		*/
		...
		$tpl->exec('spid.admin_ui.general',$content,$sel_options,$readonlys,$content);
	}
	...
	function categories($content=null)
	{
		...
		*/
		...
		$tpl= new etemplate('spid.admin.index.cats');
		$tpl->exec('spid.admin_ui.categories',$content,$sel_options,$readonlys,$content);
	}
	 ...
	 */
		...
		$tpl->exec('spid.admin_ui.edit_states', $content, $sel_options, $readonlys, $content,2);
	}
	 ...
	 */
		...
		$tpl->exec('spid.admin_ui.states', $content, $sel_options, $readonlys, array('nm' => $content['nm']));		
	}
	...
	function transitions($content=null)
	{
		...
		*/
		...
		$tpl= new etemplate('spid.admin.index.transitions');
		$tpl->exec('spid.admin_ui.transitions',$content,$sel_options,$readonlys,$content);
	}
	...
	function responses($content=null)
	{
		...
		*/
		...
		$tpl= new etemplate('spid.admin.index.cannedResponse');
		$tpl->exec('spid.admin_ui.responses',$content,$sel_options,$readonlys,$content);
	}	
	...
	function mail($content=null){
		...
		$tpl= new etemplate('spid.admin.index.mail');
		$tpl->exec('spid.admin_ui.mail',$content,$sel_options,$readonlys,$content);
		echo '<script type="text/javascript">ajax_request.LoadingInProgress();</script>';
	}
	 ...
	 */
		...
		$tpl= new etemplate('spid.admin.index.intervenant');
		$tpl->exec('spid.admin_ui.intervenants',$content,$sel_options,$readonlys,$content);
	}
	 ...
	 */
		...
		$tpl->exec('spid.admin_ui.rdv_lien',$content,$sel_options,$readonlys,$content);
	}
}
