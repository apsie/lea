...
class spid_hooks
{
	...
	*/
		...
		if ($GLOBALS['egw_info']['user']['apps']['spid'] && $location != 'admin' && $location != 'preferences'){
			...
			if($tab_acl[EGW_ACL_ADD]){
				$file[]=array(
					'text' => '<a class="textSidebox" href="'.$GLOBALS['egw']->link('/index.php',array('menuaction' => 'spid.spid_ui.edit')).
					'" onclick="window.open(this.href,\'_blank\',\'dependent=yes,width=930,height=700,scrollbars=yes,status=yes\');
					return false;">'.lang('New ticket').'</a>',
					'no_lang' => true,
					'link' => false,
				);
			}
				...
				if($tab_acl[EGW_ACL_CUSTOM_3]){
					$file['Closed tickets not invoicing']=$GLOBALS['egw']->link('/index.php','menuaction=spid.spid_ui.index&filter=viewnotinvoicing');
				}
				...
				$file[]=array(
					'text' => '<a class="textSidebox" href="'.$GLOBALS['egw']->link('/index.php',array('menuaction' => 'spid.spid_ui.search')).
					'" onclick="window.open(this.href,\'_blank\',\'dependent=yes,width=500,height=300,scrollbars=no,status=yes\');
				...
				if($GLOBALS['egw_info']['user']['SpidLevel'] >= 1){
					$file[] = array(
						'text' => '<a class="textSidebox" href="'.$GLOBALS['egw']->link('/index.php',array('menuaction' => 'spid.spid_ui.assistant')).
						'" onclick="window.open(this.href,\'_blank\',\'dependent=yes,width=930,height=500,scrollbars=yes,status=yes\');
						return false;">'.lang('Creation ticket assistant').'</a>',
						'no_lang' => true,
						'link' => false,
					);
				}
		...
		if ($GLOBALS['egw_info']['user']['apps']['spid'] && $location != 'admin' && $location != 'spid'  && $location != 'preferences'){
			$file = array();
			if($tab_acl[EGW_ACL_CUSTOM_2]){
				$file[]=array(
					'text' => '<a class="textSidebox" href="'.$GLOBALS['egw']->link('/index.php',array('menuaction' => 'spid.facture_ui.edit')).
					'" onclick="window.open(this.href,\'_blank\',\'dependent=yes,width=730,height=350,scrollbars=yes,status=yes\');
					return false;">'.lang('New invoice').'</a>',
					'no_lang' => true,
					'link' => false,
				);
				$file['Non validated invoices']=$GLOBALS['egw']->link('/index.php','menuaction=spid.facture_ui.index&filter=viewnonvalidated');
			}
			if($tab_acl[EGW_ACL_CUSTOM_3]){
				$file['Validated invoices']=$GLOBALS['egw']->link('/index.php','menuaction=spid.facture_ui.index');
			}
			if($tab_acl[EGW_ACL_CUSTOM_2]){
				$file['All invoices']=$GLOBALS['egw']->link('/index.php','menuaction=spid.facture_ui.index&filter=viewall');
				$file['Accounting export']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.accounting_export');
			}

			if($tab_acl[EGW_ACL_CUSTOM_3]){
				$file['Invoice customised lines']=$GLOBALS['egw']->link('/index.php','menuaction=spid.line_ui.index');
			}
		...
		// menu statistitiques réservé aux gestionnaires
		if ($GLOBALS['egw_info']['user']['SpidLevel'] >= 50) {
		if ($GLOBALS['egw_info']['user']['apps']['spid'] && $location != 'admin' && $location != 'spid'  && $location != 'preferences'){
			$file = array();
			if($tab_acl[EGW_ACL_CUSTOM_2]){
				$file['Client statistics']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.index');
				$file['Intervenant statistics']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.stats_intervenant');
				$file['Group statistics']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.stats_group');
				$file['Contract statistics']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.stats_contrat');
				$file['Activity monitoring']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.suivi_activite');
				$file['Tickets per intervenant']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.stats_ticket_intervenant');
			}
			if ($location == 'Statistic menu'){
				display_section($appname,$file);
			}else{
				display_sidebox($appname,lang('Statistic menu'),$file);
			}
		}
		if ($GLOBALS['egw_info']['user']['apps']['spid'] && $location != 'admin' && $location != 'spid'  && $location != 'preferences'){
			$file = array();
			if($tab_acl[EGW_ACL_CUSTOM_2]){
				$file['Client CA']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.stats_caclient');
				$file['Intervenant CA']=$GLOBALS['egw']->link('/index.php','menuaction=spid.stats_ui.stats_caintervenant');
			}
		...
		if ($GLOBALS['egw_info']['user']['apps']['preferences'] && $location != 'admin' && $location != 'spid'){
			$file = array();
		...
		if (($GLOBALS['egw_info']['user']['apps']['admin'] ||  $GLOBALS['egw_info']['user']['SpidLevel'] == 2)&& $location != 'preferences' && $location != 'spid'){
			...
			if($GLOBALS['egw_info']['user']['apps']['admin']){
				$file['General']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.general');
				$file['Categories']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.categories');
				$file['States']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.states');
				$file['Responses']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.responses');
				$file['Mail']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.mail');
			...
			$file['Intervenants']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.intervenants');

			$file['Link meetings']=$GLOBALS['egw']->link('/index.php','menuaction=spid.admin_ui.rdv_lien');
