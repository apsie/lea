...
{
	/**
	* Fonction dépréciée depuis le passage à SpiClient
	...
	* @return bool
	*/
	var more=""; var message=""; var nb=0; var erreur=false; var group=""; var company="";
	var address_one=""; var postalcode=""; var locality=""; var tva="";
	...
	if(document.getElementById("exec[account_id]"))
	{
		...
		if(group=="")
		{
			message+="- Nom du groupe<br/>"; erreur=true; nb++;
		}
	}
	if(document.getElementById("exec[client_company]"))
	{
		...
		if(company=="")
		{
			message+="- Société<br/>"; nb++; erreur=true;
		}
	}
	if(document.getElementById("exec[client_adr_one_street]"))
	{
		...
		if(address_one=="")
		{
			message+="- Adresse 1<br/>"; nb++; erreur=true;
		}
	}
	if(document.getElementById("exec[client_postalcode]"))
	{
		...
		if(postalcode=="")
		{
			message+="- Code postal<br/>"; nb++; erreur=true;
		}
	}
	if(document.getElementById("exec[client_locality]"))
	{
		...
		if(locality=="")
		{
			message+="- Ville<br/>"; nb++; erreur=true;
		}
	}
	if(document.getElementById("exec[client_tva]"))
	{
		...
		if(tva==false)
		{
			message+="- Soumis à la TVA<br/>"; 	nb++; erreur=true;
		}
	}
	if(nb>1)
	{
	...
	message="<b>Erreur"+more+" dans le"+more+" champ"+more+" suivant"+more+" :</b><br/>"+message;	
	if(erreur)
	{
...
function verif_champTickets()
{
	...
	* Revue TCH / août 2012 suite aux changements des champs...
	* @return bool
	*/
	var nb=0;
	var more="";
	...
	var client_id=document.getElementById("exec[client_id]").value;
	var ticket_assigned_by_contact=document.getElementById("exec[ticket_assigned_by_contact]").value;
	...
	if(msg!=""){
		...
		document.getElementById("exec[client_id]").removeAttribute("disabled");
