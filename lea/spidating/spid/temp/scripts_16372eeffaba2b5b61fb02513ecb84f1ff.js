...
tab_reponse['4']['canned_content'] = "Bonjour,<br /><br />Le ticket est affectÃ© Ã  <br /><br /><br />Cordialement,<br />-- <br />Support technique<br />Spirea<br />";
tab_reponse['5'] = new Object();
tab_reponse['5']['standard_reply_id'] = "6";
tab_reponse['5']['canned_content'] = "Bonjour,<br /><br />Ce ticket a Ã©tÃ© rÃ©solu dans le cadre du suivi.<br /><br /><br />Cordialement,<br />-- <br />Support technique<br />Spirea<br />";
tab_reponse['6'] = new Object();
tab_reponse['6']['standard_reply_id'] = "7";
tab_reponse['6']['canned_content'] = "Bonjour,<br /><br />Nous annulons ici ce ticket ; n'hÃ©sitez pas Ã  nous contacter pour toute question.<br /><br /><br />Cordialement,<br />-- <br />Support technique<br />Spirea<br />";
tab_reponse['7'] = new Object();
tab_reponse['7']['standard_reply_id'] = "8";
tab_reponse['7']['canned_content'] = "Bonjour,<br /><br />Cette demande est-elle toujours d'actualitÃ© ?<br /><br />Cordialement,<br />-- <br />Support technique<br />Spirea";
...
groupeClients['-34'] = new Object();
groupeClients['-34']['5'] = "Demo Account";
groupeClients['-34']['6'] = "Demo2 Account";
groupeClients['-25'] = new Object();
groupeClients['-25']['16'] = "administrateur User";
groupeClients['-25']['19'] = "gestionnaire gestionnaire";
groupeClients['-25']['37'] = "gestion 2";
groupeClients['-25']['38'] = "gestion 3";
groupeClients['-25']['17'] = "Yann Le frioux";
groupeClients['-24'] = new Object();
groupeClients['-24']['16'] = "administrateur User";
groupeClients['-24']['31'] = "Adrien Melotte";
groupeClients['-24']['23'] = "demandeur Utilisateur";
groupeClients['-24']['5'] = "Demo Account";
groupeClients['-24']['30'] = "Thomas CH";
groupeClients['-22'] = new Object();
groupeClients['-22']['16'] = "administrateur User";
groupeClients['-22']['30'] = "Thomas CH";

				//Tableau des membrerGroupesDuUser
				membrerGroupesDuUser = new Object();
membrerGroupesDuUser['-25'] = new Object();
membrerGroupesDuUser['-25']['16'] = "administrateur";
membrerGroupesDuUser['-25']['19'] = "gestionnaire";
membrerGroupesDuUser['-25']['37'] = "gestionnaire2";
membrerGroupesDuUser['-25']['38'] = "gestionnaire3";
membrerGroupesDuUser['-25']['17'] = "lfy";
membrerGroupesDuUser['-24'] = new Object();
membrerGroupesDuUser['-24']['30'] = "TCH";
membrerGroupesDuUser['-24']['16'] = "administrateur";
membrerGroupesDuUser['-24']['31'] = "ame";
membrerGroupesDuUser['-24']['23'] = "demandeur";
membrerGroupesDuUser['-24']['5'] = "demo";
membrerGroupesDuUser['-22'] = new Object();
membrerGroupesDuUser['-22']['30'] = "TCH";
membrerGroupesDuUser['-22']['16'] = "administrateur";

				//Tableau des tabDefault
				tabDefault = new Object();
tabDefault['assigned_to_id'] = null;
tabDefault[''] = "administrateur";
tabDefault['group_management_id'] = "-36";
tabDefault['group_management_value'] = "COMPTA";
tabDefault['group_management_value_users'] = new Object();
tabDefault['group_management_value_users']['35'] = "comptable";
tabDefault['demandeur'] = new Object();
tabDefault['demandeur']['16'] = "administrateur";

				//Tableau des groupesDuUser
				groupesDuUser = new Object();
groupesDuUser['-24'] = "DEMANDEURS";
groupesDuUser['-25'] = "GESTIONNAIRES";
groupesDuUser['-22'] = "Admins";
