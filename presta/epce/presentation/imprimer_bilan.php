...
<blink>Fiche �v�nement</blink> : <a href="imprimer_bilan.php?id_presta='.$_SESSION['id_presta'].'&id_ben='.$_SESSION['id_ben'].'&selection=8&email_siege=none"><img alt="Imprimer"  title="Imprimer" border="0" src="../images/print_16.png" /></a>  ou 
  <a href="imprimer_bilan.php?id_presta='.$_SESSION['id_presta'].'&id_ben='.$_SESSION['id_ben'].'&selection=8"><img alt="Imprimer"  title="Imprimer et envoyer � presta@apsie.org" border="0" src="../images/print_16.png" /><img alt="Imprimer"  title="Imprimer et envoyer � presta@apsie.org" border="0" src="../images/letter_16.png" /></a><br/>
<br/>
...
{
	$impression = new epce_impression($_GET['id_beneficiaire'],$_SESSION['id'],$_GET['id_presta']);
$impression->imprimer_totalite_emargement($_GET['id_beneficiaire'],$_SESSION['id'],$_GET['id_presta']);
}
