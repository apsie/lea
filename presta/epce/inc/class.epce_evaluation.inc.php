...
mysql_select_db(''.$this->db_name.'',$db); 	
	...
	{		
		...
		$resultat = mysql_query($requete) or die(mysql_error());
			$requete2='SELECT * FROM  egw_epce_coherence_hp where id_beneficiaire='.$id_beneficiaire.'';
		...
		{
			/*
						$pt_vigilance2=stripslashes($pt_vigilance2);
		$pt_vigilance3=stripslashes($pt_vigilance3);
		$pt_vigilance4=stripslashes($pt_vigilance4);
			$pt_vigilance=stripslashes($pt_vigilance);
$type_form4=stripslashes($type_form4);
$type_form3=stripslashes($type_form3);
$type_form2=stripslashes($type_form2);
$type_form=stripslashes($type_form);
$elem_port4=stripslashes($elem_port4);
$elem_port3=stripslashes($elem_port3);
$elem_port2=stripslashes($elem_port2);
$elem_port=stripslashes($elem_port);
$delai_prior4=stripslashes($delai_prior4);
$delai_prior3=stripslashes($delai_prior3);
$delai_prior2=stripslashes($delai_prior2);
$delai_prior=stripslashes($delai_prior);
$compet_acq4=stripslashes($compet_acq4);
$compet_acq3=stripslashes($compet_acq3);
$compet_acq2=stripslashes($compet_acq2);
$compet_acq=stripslashes($compet_acq);
$form_savoir6=stripslashes($form_savoir6);
	$form_savoir5=stripslashes($form_savoir5);
$form_savoir4=stripslashes($form_savoir4);
$form_savoir3=stripslashes($form_savoir3);
$form_savoir2=stripslashes($form_savoir2);
$form_savoir=stripslashes($form_savoir);
$comp_pro6=stripslashes($comp_pro6);
$comp_pro5=stripslashes($comp_pro5);
$comp_pro4=stripslashes($comp_pro4);
$comp_pro3=stripslashes($comp_pro3);
$comp_pro2=stripslashes($comp_pro2);
	$comp_pro=stripslashes($comp_pro);
	$exp_pro=stripslashes($exp_pro);
...
$this->db->insert('egw_epce_coherence_hp',$data);
	}
	//$resultat = mysql_query($requete) or die(mysql_error());
	}
...
//$requete = "insert into egw_epce_coherence_hp value ('', '$id_beneficiaire','$exp_pro', '$exp_pro2', '$exp_pro3','$exp_pro4', '$exp_pro5', '$exp_pro6', '$comp_pro', '$comp_pro2', '$comp_pro3', '$comp_pro4', '$comp_pro5', '$comp_pro6', '$form_savoir', '$form_savoir2', '$form_savoir3', '$form_savoir4', '$form_savoir5','$form_savoir6', '$compet_acq', '$compet_acq2','$compet_acq3','$compet_acq4', '$delai_prior', '$delai_prior2', '$delai_prior3', '$delai_prior4','$type_form', '$type_form2', '$type_form3', '$type_form4', '$elem_port', '$elem_port2', '$elem_port3', '$elem_port4', '$pt_vigilance', '$pt_vigilance2', '$pt_vigilance3','$pt_vigilance4','$diagnostic','$id_presta')";
$this->db->update('egw_epce_coherence_hp',$data,'id_presta='.$id_presta);
	//$requete = "Update egw_epce_coherence_hp set exp_pro='$exp_pro', exp_pro2='$exp_pro2', exp_pro3='$exp_pro3', exp_pro4='$exp_pro4', exp_pro5='$exp_pro5', exp_pro6='$exp_pro6', comp_pro='$comp_pro', comp_pro2='$comp_pro2', comp_pro3='$comp_pro3', comp_pro4='$comp_pro4', comp_pro5='$comp_pro5', comp_pro6='$comp_pro6', form_savoir='$form_savoir', form_savoir2='$form_savoir2', form_savoir3='$form_savoir3', form_savoir4='$form_savoir4', form_savoir5='$form_savoir5', form_savoir6='$form_savoir6', compet_acq='$compet_acq', compet_acq2='$compet_acq2', compet_acq3='$compet_acq3', compet_acq4='$compet_acq4', delai_prior='$delai_prior', delai_prior2='$delai_prior2', delai_prior3='$delai_prior3', delai_prior4='$delai_prior4', type_form='$type_form', type_form2='$type_form2', type_form3='$type_form3', type_form4='$type_form4', elem_port='$elem_port', elem_port2='$elem_port2', elem_port3='$elem_port3', elem_port4='$elem_port4', pt_vigilance='$pt_vigilance', pt_vigilance2='$pt_vigilance2', pt_vigilance3='$pt_vigilance3', pt_vigilance4='$pt_vigilance4' , diagnostic='$diagnostic' where id_presta = $id_presta";
...
//	$resultat = mysql_query($requete) or die(mysql_error());
	...
	function variable_coherence($id_presta,$id_beneficiaire)
	{	
	  $requete='SELECT * FROM  egw_prestation where id_ben='.$id_beneficiaire.'';
...
$comp_pro2=addslashes($comp_pro2);
	...
	// Fonctions li�es � la table aspect_commercial -------------------------------------------------
...
//$requete = "insert into egw_epce_aspect_commercial value ('', '$id_beneficiaire','$analyse_besoin_client_pt_forts','$analyse_besoin_client_pt_forts2','$analyse_besoin_client_pt_forts3','$analyse_besoin_client_pt_forts4', '$analyse_besoin_client_pt_faible','$analyse_besoin_client_pt_faible2','$analyse_besoin_client_pt_faible3','$analyse_besoin_client_pt_faible4','$analyse_concurrence_pt_fort','$analyse_concurrence_pt_fort2','$analyse_concurrence_pt_fort3','$analyse_concurrence_pt_fort4', '$analyse_concurrence_pt_faible','$analyse_concurrence_pt_faible2','$analyse_concurrence_pt_faible3','$analyse_concurrence_pt_faible4','$strategie_commerciale_envisagee_pt_fort','$strategie_commerciale_envisagee_pt_fort2','$strategie_commerciale_envisagee_pt_fort3','$strategie_commerciale_envisagee_pt_fort4','$strategie_commerciale_envisagee_pt_faible','$strategie_commerciale_envisagee_pt_faible2','$strategie_commerciale_envisagee_pt_faible3','$strategie_commerciale_envisagee_pt_faible4', '$autre_pt_fort','$autre_pt_fort2','$autre_pt_fort3','$autre_pt_fort4', '$autre_pt_faible','$autre_pt_faible2','$autre_pt_faible3','$autre_pt_faible4', '$action_a_mener1', '$action_a_mener2','$action_a_mener3', '$action_a_mener4', '$delai_de_realisation1', '$delai_de_realisation2', '$delai_de_realisation3','$delai_de_realisation4','$resultat_attendus1','$resultat_attendus2','$resultat_attendus3','$resultat_attendus4','$diagnostic','$id_presta')";
		...
		$this->db->insert('egw_epce_aspect_commercial',$data);
		}
	//$resultat = mysql_query($requete) or die(mysql_error());
	}
...
function update_aspect_commercial( $id_beneficiaire, $analyse_besoin_client_pt_forts, $analyse_besoin_client_pt_forts2,$analyse_besoin_client_pt_forts3,$analyse_besoin_client_pt_forts4,$analyse_besoin_client_pt_faible,$analyse_besoin_client_pt_faible2,$analyse_besoin_client_pt_faible3,$analyse_besoin_client_pt_faible4, $analyse_concurrence_pt_fort,$analyse_concurrence_pt_fort2,$analyse_concurrence_pt_fort3,$analyse_concurrence_pt_fort4, $analyse_concurrence_pt_faible, $analyse_concurrence_pt_faible2,$analyse_concurrence_pt_faible3,$analyse_concurrence_pt_faible4,$strategie_commerciale_envisagee_pt_fort,$strategie_commerciale_envisagee_pt_fort2,$strategie_commerciale_envisagee_pt_fort3,$strategie_commerciale_envisagee_pt_fort4, $strategie_commerciale_envisagee_pt_faible, $strategie_commerciale_envisagee_pt_faible2, $strategie_commerciale_envisagee_pt_faible3, $strategie_commerciale_envisagee_pt_faible4, $autre_pt_fort,$autre_pt_fort2,$autre_pt_fort3,$autre_pt_fort4, $autre_pt_faible,$autre_pt_faible2,$autre_pt_faible3,$autre_pt_faible4, $action_a_mener1, $action_a_mener2, $action_a_mener3, $action_a_mener4, $delai_de_realisation1, $delai_de_realisation2, $delai_de_realisation3, $delai_de_realisation4, $resultat_attendus1, $resultat_attendus2, $resultat_attendus3, $resultat_attendus4, $diagnostic,$id_presta)
	{
	/*$requete = "Update egw_epce_aspect_commercial set  analyse_besoin_client_pt_forts='$analyse_besoin_client_pt_forts',analyse_besoin_client_pt_forts2='$analyse_besoin_client_pt_forts2',analyse_besoin_client_pt_forts3='$analyse_besoin_client_pt_forts3',analyse_besoin_client_pt_forts4='$analyse_besoin_client_pt_forts4', analyse_besoin_client_pt_faible= '$analyse_besoin_client_pt_faible',analyse_besoin_client_pt_faible2= '$analyse_besoin_client_pt_faible2',analyse_besoin_client_pt_faible3= '$analyse_besoin_client_pt_faible3',analyse_besoin_client_pt_faible4= '$analyse_besoin_client_pt_faible4', analyse_concurrence_pt_fort='$analyse_concurrence_pt_fort',analyse_concurrence_pt_fort2='$analyse_concurrence_pt_fort2',analyse_concurrence_pt_fort3='$analyse_concurrence_pt_fort3',analyse_concurrence_pt_fort4='$analyse_concurrence_pt_fort4',  analyse_concurrence_pt_faible='$analyse_concurrence_pt_faible',analyse_concurrence_pt_faible2='$analyse_concurrence_pt_faible2',analyse_concurrence_pt_faible3='$analyse_concurrence_pt_faible3',analyse_concurrence_pt_faible4='$analyse_concurrence_pt_faible4', strategie_commerciale_envisagee_pt_fort='$strategie_commerciale_envisagee_pt_fort',strategie_commerciale_envisagee_pt_fort='$strategie_commerciale_envisagee_pt_fort',strategie_commerciale_envisagee_pt_fort2='$strategie_commerciale_envisagee_pt_fort2',strategie_commerciale_envisagee_pt_fort3='$strategie_commerciale_envisagee_pt_fort3',strategie_commerciale_envisagee_pt_fort4='$strategie_commerciale_envisagee_pt_fort4',  strategie_commerciale_envisagee_pt_faible='$strategie_commerciale_envisagee_pt_faible', strategie_commerciale_envisagee_pt_faible2='$strategie_commerciale_envisagee_pt_faible2', strategie_commerciale_envisagee_pt_faible3='$strategie_commerciale_envisagee_pt_faible3', strategie_commerciale_envisagee_pt_faible4='$strategie_commerciale_envisagee_pt_faible4', autre_pt_fort='$autre_pt_fort',autre_pt_fort2='$autre_pt_fort2',autre_pt_fort3='$autre_pt_fort3',autre_pt_fort4='$autre_pt_fort4', autre_pt_faible='$autre_pt_faible', autre_pt_faible2='$autre_pt_faible2',autre_pt_faible3='$autre_pt_faible3',autre_pt_faible4='$autre_pt_faible4',action_a_mener1='$action_a_mener1', action_a_mener2='$action_a_mener2', action_a_mener3='$action_a_mener3', action_a_mener4='$action_a_mener4', delai_de_realisation1='$delai_de_realisation1', delai_de_realisation2='$delai_de_realisation2',  delai_de_realisation3='$delai_de_realisation3', delai_de_realisation4='$delai_de_realisation4', resultat_attendus1='$resultat_attendus1', resultat_attendus2='$resultat_attendus2', resultat_attendus3='$resultat_attendus3', resultat_attendus4='$resultat_attendus4', diagnostic='$diagnostic' where id_presta = $id_presta";
	...
	$resultat = mysql_query($requete) or die(mysql_error());*/
		...
		$this->db->update('egw_epce_aspect_commercial',$data,'id_presta='.$id_presta);
	}
	...
	$resultat = mysql_query($requete) or die(mysql_error());
		...
		{
		$requete='SELECT * FROM  egw_epce_aspect_commercial where id_presta='.$id_presta.'';
	...
	function inserer_aspect_financier($id, $id_beneficiaire, $apport_pt_forts,$apport_pt_forts2,$apport_pt_forts3,$apport_pt_forts4, $apportt_pt_faible,$apportt_pt_faible,$apportt_pt_faible2,$apportt_pt_faible3,$apportt_pt_faible4, $calcul_pt_fort,$calcul_pt_fort2,$calcul_pt_fort3,$calcul_pt_fort4, $calcul_pt_faible,$calcul_pt_faible2,$calcul_pt_faible3,$calcul_pt_faible4, $plan_initial_pt_fort,$plan_initial_pt_fort2,$plan_initial_pt_fort3,$plan_initial_pt_fort4, $plan_initial_pt_faible,$plan_initial_pt_faible2,$plan_initial_pt_faible3,$plan_initial_pt_faible4, $plan_trois_ans_pt_fort,$plan_trois_ans_pt_fort2,$plan_trois_ans_pt_fort3,$plan_trois_ans_pt_fort4, $plan_trois_ans_pt_faible,$plan_trois_ans_pt_faible2,$plan_trois_ans_pt_faible3,$plan_trois_ans_pt_faible4, $autre_pt_fort,$autre_pt_fort2,$autre_pt_fort3,$autre_pt_fort4, $autre_pt_faible,$autre_pt_faible2,$autre_pt_faible3,$autre_pt_faible4, $action_a_mener1, $action_a_mener2, $action_a_mener3, $action_a_mener4, $delai_de_realisation1, $delai_de_realisation2, $delai_de_realisation3, $delai_de_realisation4, $resultat_attendus1, $resultat_attendus2, $resultat_attendus3, $resultat_attendus4, $diagnostic,$id_presta)
	{
		...
		$resultat = mysql_query($requete) or die(mysql_error());
			$requete2='SELECT * FROM  egw_epce_aspect_financier where id_beneficiaire='.$id_beneficiaire.'';
...
$diagnostic=stripslashes($diagnostic);*/
	//$requete = "Update egw_epce_aspect_financier set apport_pt_forts='$apport_pt_forts',apport_pt_forts2='$apport_pt_forts2',apport_pt_forts3='$apport_pt_forts3',apport_pt_forts4='$apport_pt_forts4', apportt_pt_faible='$apportt_pt_faible',apportt_pt_faible2='$apportt_pt_faible2',apportt_pt_faible3='$apportt_pt_faible3',apportt_pt_faible4='$apportt_pt_faible4', calcul_pt_fort='$calcul_pt_fort',calcul_pt_fort2='$calcul_pt_fort2',calcul_pt_fort3='$calcul_pt_fort3',calcul_pt_fort4='$calcul_pt_fort4', calcul_pt_faible='$calcul_pt_faible',calcul_pt_faible2='$calcul_pt_faible2',calcul_pt_faible3='$calcul_pt_faible3',calcul_pt_faible4='$calcul_pt_faible4', plan_initial_pt_fort='$plan_initial_pt_fort',plan_initial_pt_fort2='$plan_initial_pt_fort2',plan_initial_pt_fort3='$plan_initial_pt_fort3',plan_initial_pt_fort4='$plan_initial_pt_fort4', plan_initial_pt_faible='$plan_initial_pt_faible',plan_initial_pt_faible2='$plan_initial_pt_faible2',plan_initial_pt_faible3='$plan_initial_pt_faible3',plan_initial_pt_faible4='$plan_initial_pt_faible4', plan_trois_ans_pt_fort='$plan_trois_ans_pt_fort',plan_trois_ans_pt_fort2='$plan_trois_ans_pt_fort2',plan_trois_ans_pt_fort3='$plan_trois_ans_pt_fort3',plan_trois_ans_pt_fort4='$plan_trois_ans_pt_fort4', plan_trois_ans_pt_faible='$plan_trois_ans_pt_faible',plan_trois_ans_pt_faible2='$plan_trois_ans_pt_faible2',plan_trois_ans_pt_faible3='$plan_trois_ans_pt_faible3',plan_trois_ans_pt_faible4='$plan_trois_ans_pt_faible4', autre_pt_fort='$autre_pt_fort',autre_pt_fort2='$autre_pt_fort2',autre_pt_fort3='$autre_pt_fort3',autre_pt_fort4='$autre_pt_fort4', autre_pt_faible='$autre_pt_faible', autre_pt_faible2='$autre_pt_faible2',autre_pt_faible3='$autre_pt_faible3',autre_pt_faible4='$autre_pt_faible4',action_a_mener1='$action_a_mener1', action_a_mener2='$action_a_mener2', action_a_mener3='$action_a_mener3', action_a_mener4='$action_a_mener4', delai_de_realisation1='$delai_de_realisation1', delai_de_realisation2='$delai_de_realisation2', delai_de_realisation3='$delai_de_realisation3', delai_de_realisation4='$delai_de_realisation4', resultat_attendus1='$resultat_attendus1', resultat_attendus2='$resultat_attendus2', resultat_attendus3='$resultat_attendus3', resultat_attendus4='$resultat_attendus4', diagnostic='$diagnostic',id_presta='$id_presta' where id_beneficiaire=$id_beneficiaire";
		...
		else
		{
			...
			$this->db->insert('egw_epce_aspect_financier',$data);
	//$requete = "insert into egw_epce_aspect_financier value ('', '$id_beneficiaire', '$apport_pt_forts','$apport_pt_forts2','$apport_pt_forts3','$apport_pt_forts4', '$apportt_pt_faible','$apportt_pt_faible2','$apportt_pt_faible3','$apportt_pt_faible4', '$calcul_pt_fort','$calcul_pt_fort2','$calcul_pt_fort3','$calcul_pt_fort4', '$calcul_pt_faible','$calcul_pt_faible2','$calcul_pt_faible3','$calcul_pt_faible4', '$plan_initial_pt_fort','$plan_initial_pt_fort2','$plan_initial_pt_fort3','$plan_initial_pt_fort4',
	// '$plan_initial_pt_faible', '$plan_initial_pt_faible2','$plan_initial_pt_faible3','$plan_initial_pt_faible4','$plan_trois_ans_pt_fort','$plan_trois_ans_pt_fort2','$plan_trois_ans_pt_fort3','$plan_trois_ans_pt_fort4', '$plan_trois_ans_pt_faible','$plan_trois_ans_pt_faible2','$plan_trois_ans_pt_faible3','$plan_trois_ans_pt_faible4', '$autre_pt_fort','$autre_pt_fort2','$autre_pt_fort3','$autre_pt_fort4', '$autre_pt_faible','$autre_pt_faible2','$autre_pt_faible3','$autre_pt_faible4',
	//'$action_a_mener1', '$action_a_mener2', '$action_a_mener3', '$action_a_mener4', '$delai_de_realisation1', '$delai_de_realisation2', '$delai_de_realisation3', '$delai_de_realisation4', '$resultat_attendus1', '$resultat_attendus2', '$resultat_attendus3', '$resultat_attendus4', '$diagnostic','$id_presta')";
		}
	//$resultat= mysql_query($requete) or die(mysql_error());
...
function update_aspect_financier($id_beneficiaire, $apport_pt_forts,$apport_pt_forts2,$apport_pt_forts3,$apport_pt_forts4, $apportt_pt_faible,$apportt_pt_faible2,$apportt_pt_faible3,$apportt_pt_faible4, $calcul_pt_fort,$calcul_pt_fort2,$calcul_pt_fort3,$calcul_pt_fort4, $calcul_pt_faible,$calcul_pt_faible2,$calcul_pt_faible3,$calcul_pt_faible4, $plan_initial_pt_fort,$plan_initial_pt_fort2,$plan_initial_pt_fort3,$plan_initial_pt_fort4, $plan_initial_pt_faible,$plan_initial_pt_faible2,$plan_initial_pt_faible3,$plan_initial_pt_faible4, $plan_trois_ans_pt_fort,$plan_trois_ans_pt_fort2,$plan_trois_ans_pt_fort3,$plan_trois_ans_pt_fort4, $plan_trois_ans_pt_faible,$plan_trois_ans_pt_faible2,$plan_trois_ans_pt_faible3,$plan_trois_ans_pt_faible4, $autre_pt_fort,$autre_pt_fort2,$autre_pt_fort3,$autre_pt_fort4, $autre_pt_faible,$autre_pt_faible2,$autre_pt_faible3,$autre_pt_faible4, $action_a_mener1, $action_a_mener2, $action_a_mener3, $action_a_mener4, $delai_de_realisation1, $delai_de_realisation2, $delai_de_realisation3, $delai_de_realisation4, $resultat_attendus1, $resultat_attendus2, $resultat_attendus3, $resultat_attendus4, $diagnostic,$id_presta)
	{
			...
			$this->db->update('egw_epce_aspect_financier',$data,'id_presta='.$id_presta);
	...
	$resultat = mysql_query($requete) or die(mysql_error());
		...
		{
		$requete='SELECT * FROM  egw_epce_aspect_financier where id_presta='.$id_presta.'';
...
//$diagnostic=addslashes($diagnostic);
	...
	//Fonctions li�es � la table forme_juridique----------------------------------------------------
...
$requete='SELECT * FROM  egw_prestation where id_presta='.$id_presta.'';
		...
		$resultat = mysql_query($requete) or die(mysql_error());
			$requete2='SELECT * FROM  egw_epce_forme_juridique where id_presta='.$id_presta.'';
...
$pt_fort=addslashes($pt_fort);
		...
		$resultat_attendus4=addslashes($resultat_attendus4);*/
		//$diagnostic=addslashes($diagnostic);
	//$requete = "insert into egw_epce_forme_juridique value ('', '$id_beneficiaire', '$pt_fort', '$pt_fort2', '$pt_fort3', '$pt_fort4', '$pt_faible', '$pt_faible2', '$pt_faible3', '$pt_faible4', '$action_mener1', '$action_mener2', '$action_mener3',	'$action_mener4', '$delai_realisation1', '$delai_realisation2', '$delai_realisation3', '$delai_realisation4', '$resultat_attendus1', '$resultat_attendus2', '$resultat_attendus3', '$resultat_attendus4', '$diagnostic','$id_presta')";
		$data['id_beneficiaire'] = $id_beneficiaire;
		...
		$data['id_presta'] = $id_presta;
		//print_r($data);die();
		$this->db->insert('egw_epce_forme_juridique',$data);
		}
	//$resultat = mysql_query($requete) or die(mysql_error());
	...
	//$resultat = mysql_query($requete) or die(mysql_error());
		...
		$this->db->update('egw_epce_forme_juridique',$data,'id_presta='.$id_presta);
	}
	...
	$resultat = mysql_query($requete) or die(mysql_error());
		...
		{
		$requete='SELECT * FROM  egw_epce_forme_juridique  where id_presta='.$id_presta.'';
	...
	function verif_beneficiaire_forme_juridique($id_beneficiaire, $pt_fort, $pt_fort2, $pt_fort3, $pt_fort4, $pt_faible, $pt_faible2, $pt_faible3, $pt_faible4, $action_mener, $action_mener2, $action_mener3, $action_mener4, $delai_realisation, $delai_realisation2, $delai_realisation3, $delai_realisation4, $resultat_attendus, $resultat_attendus2, $resultat_attendus3, $resultat_attendus4, $diagnostic,$id_presta)
		...
		//Fonctions li�es � la table aspect_reglementaire----------------------------------------------------
	...
	//Fonction de v�rification 'id_beneficiaire (aspect_reglementaire)
	
	//V�rification de l'id_beneficiaire dans la table aspect_reglementaire
	//Si il existe faire une mise � jour , sinon le cr�er
	...
	//Fonctions li�es � la table epce_plan_eval----------------------------------------------------
		//Fonction d'insertion (epce_plan_eval)
		
	function inserer_plan_eval($id, $id_beneficiaire, $descrip_proj, $etat_proj, $pt_a_evaluer, $attente_benef, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$pt_a_evaluer2,$pt_a_evaluer3,$attente_benef2,$attente_benef3,$id_presta)
	{
		
			$requete='SELECT * FROM  egw_prestation where id_ben='.$id_beneficiaire.'';
		
		$resultat = mysql_query($requete) or die(mysql_error());
			$requete2='SELECT * FROM  egw_epce_plan_eval where id_beneficiaire='.$id_beneficiaire.'';
		...
		//$pt_a_evaluer=stripslashes($pt_a_evaluer);
		//$pt_a_evaluer2=stripslashes($pt_a_evaluer2);
		//$pt_a_evaluer3=stripslashes($pt_a_evaluer3);
    	//$attente_benef=stripslashes($attente_benef);
		//$attente_benef2=stripslashes($attente_benef2);
		//$attente_benef3=stripslashes($attente_benef3);
		//$descrip_proj=($descrip_proj);
		//$etat_proj=stripslashes($etat_proj);
		//$comment_ref=stripslashes($comment_ref);
		...
		$attente_benef3=addslashes($attente_benef3);
		
		$etat_proj=addslashes($etat_proj);*/
			//die('tzt'.$attente_benef2);		
	//$requete = "Update egw_epce_plan_eval set descrip_proj='$descrip_proj', etat_proj='$etat_proj', pt_a_evaluer='$pt_a_evaluer',pt_a_evaluer2='$pt_a_evaluer2',pt_a_evaluer3='$pt_a_evaluer3', attente_benef='$attente_benef',attente_benef2='$attente_benef2',attente_benef3='$attente_benef3', comment_ref='$comment_ref', pt_date1='$pt_date1', pt_date2='$pt_date2', diagnostic1_date1='$diagnostic1_date1', diagnostic1_date2='$diagnostic1_date2', diagnostic2_date1='$diagnostic2_date1', diagnostic2_date2='$diagnostic2_date2', pt_plan_date1='$pt_plan_date1', pt_plan_date2='$pt_plan_date2' , sign='$sign',id_presta='$id_presta'  where id_beneficiaire=$id_beneficiaire";
		}
		else
		{
			$data['id_beneficiaire'] = $id_beneficiaire;
			$data['descrip_proj'] = $descrip_proj;
			$data['etat_proj'] = $etat_proj;
			$data['pt_a_evaluer'] = $pt_a_evaluer;
			$data['pt_a_evaluer2'] = $pt_a_evaluer2;
			$data['pt_a_evaluer3'] = $pt_a_evaluer3;
			$data['attente_benef'] = $attente_benef;
			$data['attente_benef2'] = $attente_benef2;
			$data['attente_benef3'] = $attente_benef3;
			$data['comment_ref'] = $comment_ref;
			$data['pt_date1'] = $pt_date1;
			$data['pt_date2'] = $pt_date2;
			$data['diagnostic1_date1'] = $diagnostic1_date1;
			$data['diagnostic1_date2'] = $diagnostic1_date2;
			$data['diagnostic2_date1'] = $diagnostic2_date1;
			$data['diagnostic2_date2'] = $diagnostic2_date2;
			$data['pt_plan_date1'] = $pt_plan_date1;
			$data['pt_plan_date2'] = $pt_plan_date2;
			$data['sign'] = $sign;
			$data['id_presta'] = $id_presta;
			$this->db->insert('egw_epce_plan_eval',$data);
			/*$comment_ref = addslashes($comment_ref);
			$descrip_proj = addslashes($descrip_proj);*/
		//	die($comment_ref);
	//$requete = "insert into egw_epce_plan_eval value ('', '$id_beneficiaire', '$descrip_proj', '$etat_proj', '$pt_a_evaluer','$pt_a_evaluer2','$pt_a_evaluer3', '$attente_benef', '$attente_benef2','$attente_benef3', '$comment_ref', '$pt_date1', '$pt_date2', '$diagnostic1_date1', '$diagnostic1_date2', '$diagnostic2_date1', '$diagnostic2_date2', '$pt_plan_date1', '$pt_plan_date2','$sign','$id_presta')";
		}
	//$resultat = mysql_query($requete) or die(mysql_error());
	
	}
	
	//Fonction de la mise � jour (plan_eval)
	
	function update_plan_eval($id_beneficiaire, $descrip_proj, $etat_proj, $pt_a_evaluer, $attente_benef, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2 , $sign,$pt_a_evaluer2,$pt_a_evaluer3,$attente_benef2,$attente_benef3,$id_presta)
	{
	...
	/*	$requete='SELECT * FROM  egw_epce_plan_eval where id_beneficiaire='.$id_beneficiaire.'';
		...
		*/
	/*$pt_a_evaluer=addslashes(stripslashes($pt_a_evaluer));
		$pt_a_evaluer2=addslashes(stripslashes($pt_a_evaluer2));
		$pt_a_evaluer3=addslashes(stripslashes($pt_a_evaluer3));
    	$attente_benef=addslashes(stripslashes($attente_benef));
		$attente_benef2=addslashes(stripslashes($attente_benef2));
		$attente_benef3=addslashes(stripslashes($attente_benef3));
		...
		$descrip_proj=addslashes($descrip_proj);
		$comment_ref=addslashes($comment_ref);
	$requete = "Update egw_epce_plan_eval set descrip_proj='$descrip_proj', etat_proj='$etat_proj', pt_a_evaluer='$pt_a_evaluer',pt_a_evaluer2='$pt_a_evaluer2',pt_a_evaluer3='$pt_a_evaluer3', attente_benef='$attente_benef',attente_benef2='$attente_benef2',attente_benef3='$attente_benef3', comment_ref='$comment_ref', pt_date1='$pt_date1', pt_date2='$pt_date2', diagnostic1_date1='$diagnostic1_date1', diagnostic1_date2='$diagnostic1_date2', diagnostic2_date1='$diagnostic2_date1', diagnostic2_date2='$diagnostic2_date2', pt_plan_date1='$pt_plan_date1', pt_plan_date2='$pt_plan_date2' , sign='$sign'  where id_presta=$id_presta";
	...
	$resultat = mysql_query($requete) or die(mysql_error());*/
		//$data['id_beneficiaire'] = $id_beneficiaire;
			...
			$data['sign'] = $sign;
			$data['id_presta'] = $id_presta;
			$this->db->update('egw_epce_plan_eval',$data,'id_presta='.$id_presta);
			
	}
	
	//Fonction de s�lection (plan_eval)
	
		function plan_eval($id_presta,$id_beneficiaire)
	{	
	
			if($id_presta!=null)
			{
			$sql='SELECT pr.* FROM  egw_prestation p left join egw_projet pr on pr.id_projet = p.id_projet where id_presta='.$id_presta.''; 
			$resultat = mysql_query($sql) or die(mysql_error());
			$row_projet = mysql_fetch_array($resultat);
			//print_r($row_projet); die($sql);
			$descrip_proj=$row_projet['description_projet'];
			}
		...
		{
		$requete='SELECT * FROM  egw_epce_plan_eval where id_presta='.$id_presta.'';
		...
		while($row = mysql_fetch_array($resultat))
		{
			...
			$attente_benef3=$row['attente_benef3'];
			$comment_ref=$row['comment_ref'];
		...
		return array($descrip_proj, $etat_proj, $pt_a_evaluer, $attente_benef, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$pt_a_evaluer2,$pt_a_evaluer3,$attente_benef2,$attente_benef3);
	
	}	
	
	
	//Fonction de v�rification 'id_beneficiaire (plan_eval)
	
	//V�rification de l'id_beneficiaire dans la table plan_aval
	//Si il existe faire une mise � jour , sinon le cr�er
	
	function verif_beneficiaire_plan_eval($id_beneficiaire, $descrip_proj, $etat_proj, $pt_a_evaluer, $pt_a_evaluer2, $pt_a_evaluer3, $attente_benef,$attente_benef2,$attente_benef3, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$id_presta)
		...
		if(is_numeric($attente_benef3)==true)
		
		{
	 
		$requete='SELECT * FROM  egw_epce_texte where id='.$attente_benef3.'';
		$resultat = mysql_query($requete) or die(mysql_error());
		while($row = mysql_fetch_array($resultat))
		{
			$attente_benef3=$row['valeur'];
					$attente_benef3_=addslashes($attente_benef3);		
		...
		{
		$attente_benef3_=$attente_benef3;	
		}
		...
		//$comment_ref=addslashes($comment_ref);
		*/
		 $this->inserer_plan_eval($id, $id_beneficiaire, $descrip_proj, $etat_proj, $pt_a_evaluer, $attente_benef, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$pt_a_evaluer2,$pt_a_evaluer3,$attente_benef2,$attente_benef3,$id_presta);
		...
		$this->update_plan_eval($id_beneficiaire, $descrip_proj, $etat_proj, $pt_a_evaluer, $attente_benef, $comment_ref, $pt_date1, $pt_date2, $diagnostic1_date1, $diagnostic1_date2, $diagnostic2_date1, $diagnostic2_date2, $pt_plan_date1, $pt_plan_date2,$sign,$pt_a_evaluer2,$pt_a_evaluer3,$attente_benef2,$attente_benef3,$id_presta);	
		return 'none';
		}	
	...
	function inserer_bilan_avis($id_beneficiaire, $avis1, $commentaire1, $avis2, $commentaire2,$r_emploi,$rome,$com_ref,$com_ben,$id_presta)
	{
		...
		$resultat = mysql_query($requete) or die(mysql_error());
			$requete2='SELECT * FROM  egw_epce_bilan_avis where id_beneficiaire='.$id_beneficiaire.'';
		
		$resultat2 = mysql_query($requete2) or die(mysql_error());
		
		if(mysql_num_rows($resultat)>=1 and mysql_num_rows($resultat2)>=1 )
		{
			//$requete3 = "Update egw_epce_bilan_avis set code_rome='$rome', avis1='$avis1', commentaire1='$commentaire1', avis2='$avis2', commentaire2='$commentaire2',com_ref='$com_ref',com_ben='$com_ben',  r_emploi='$r_emploi',id_presta=$id_presta where id_beneficiaire=$id_beneficiaire";
		}
		else
		{
	//$requete3 = "insert into egw_epce_bilan_avis value ('', '$id_beneficiaire', '$avis1', '$commentaire1', '$avis2', '$commentaire2','$r_emploi','$rome','$com_ref','$com_ben','$id_presta')";
	$data['id_beneficiaire'] = $id_beneficiaire;
	$data['avis1'] = $avis1;
	...
	$this->db->insert('egw_epce_bilan_avis',$data);
	}
	...
	{
	/*$requete = "Update egw_epce_bilan_avis set code_rome='$rome', avis1='$avis1', commentaire1='$commentaire1', avis2='$avis2', commentaire2='$commentaire2',com_ref='$com_ref',com_ben='$com_ben',  r_emploi='$r_emploi' where id_presta=$id_presta";
	...
	//$data['id_presta'] = $id_presta;
	//die('t'.$id_presta);
	$this->db->update('egw_epce_bilan_avis',$data,'id_presta='.$id_presta);
	}
	...
	{	
		...
		$requete='SELECT * FROM  egw_epce_bilan_avis where id_presta='.$id_presta.'';
