...
if($eligible_dispo[0]!=NULL)
{
	...
	$id_projet=$epce->selectionner_projet_ben($id_verif,$_SESSION['id'],$_SESSION['id'],$_POST['prestation'],$dat_debu,$n_family.' '.$n_given,'En cours');
...
$_POST['opt']=$epce->inserer_cal($titre,$_POST['lieu'],'',$_POST['conseiller_id']);
...
if(isset($_POST['opt']) and $_POST['opt']!=NULL)
{
$epce->link_beneficiaire_calendar($id_verif,$_POST['opt'],$nb,$n_given,$n_family,$tel_work,$tel_cell,$_POST['n_lettre'],$_POST['id_pole'],$_POST['nom_p'],$_POST['prenom_p'],$tel_home,$_POST['code_safir'],$_POST['tel_bureau_p'],$_POST['tel_portable_p'],$_POST['debut_date'],$id_presta);
...
$id_projet=$epce->inserer_beneficiaire_projet($_SESSION['id'],$id_recup,$dat_debu,$_POST['prestation'],$n_family.' '.$n_given,$_POST['account_id'],'En cours','En attente de résultat');
...
if(isset($_POST['opt']) and $_POST['opt']!=NULL)
{
$epce->link_beneficiaire_calendar($id_recup,$_POST['opt'],$nb,$n_given,$n_family,$tel_work,$tel_cell,$_POST['n_lettre'],$_POST['id_pole'],$_POST['nom_p'],$_POST['prenom_p'],$tel_home,$_POST['code_safir'],$_POST['tel_bureau_p'],$_POST['tel_portable_p'],$_POST['debut_date'],$id_presta);
