...
$requete='SELECT  egw_rapport_activite.date, egw_rapport_activite.commentaire,egw_accounts.account_lastname,egw_accounts.account_firstname FROM egw_rapport_activite,egw_accounts where id_conseiller ='.$id_con.' and account_id ='.$id_con.' and egw_rapport_activite.date>'.$temp.' order by id desc';
...
function identite($id)
{
			...
			$requete='SELECT  account_lastname,account_firstname FROM egw_accounts where account_id='.$id.' ';
