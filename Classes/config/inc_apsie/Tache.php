...
//spirea - modif du chemin pour mettre en dur... include('config/config.php');
...
class Tache {
	...
	echo '<form><table><tr><td height="53">Dans le cadre du projet</td><th colspan="4" align="left"><input size="70" type="text"/></th></tr><tr><td>Date de début</td><td><input type="text" value="'.date('d/m/Y',time()).'" size="7" /> <select><option>9</option></select> h</td><td>Date de fin</td><td><input size="7" value="'.date('d/m/Y',time()).'" type="text" /> <select><option>10</option></select> h</td></tr><tr><td>Durée trajet</td>
