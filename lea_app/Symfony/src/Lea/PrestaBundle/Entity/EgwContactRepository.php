...
/**
 *  EgwContactRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class EgwContactRepository extends EntityRepository {
...
//            $c->setOrganisation($params['EgwContact']['organisation']);
...
//            $c->setFonction($params['EgwContact']['fonction']);
            ...
            // Etat civil
            $c->setIdSEcu($params['EgwContact']['idSecu']);
            $c->setDateNaissance($params['EgwContact']['dateNaissance']);
            $c->setLieuNaissance($params['EgwContact']['lieuNaissance']);
            $c->setPaysNaissance($params['EgwContact']['paysNaissance']);
            $c->setNationalite($params['EgwContact']['nationalite']);
            $c->setSituationMaritale($params['EgwContact']['situationMaritale']);
            $c->setEnfantsACharge($params['EgwContact']['enfantsACharge']);
            ...
            $c->setTelDomicile1($params['EgwContact']['telDomicile1']);
            $c->setEmailPerso($params['EgwContact']['emailPerso']);
            $c->setEmailPro($params['EgwContact']['']);
            $c->setIdOrganisation('');
            $c->setOrganisation('');
            $c->setService('');
            $c->setFonction('');
	...
	if($cFormation){
        	$cFormation[0]->setNiveauFormation($params['EgwFormationContact']['niveauFormation']);
	        $cFormation[0]->setIntituleFormation($params['EgwFormationContact']['intituleFormation']);
