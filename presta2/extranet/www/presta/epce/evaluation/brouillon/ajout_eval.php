...
projet</td><td><input type="text" onkeyup="lookup_text(this.value);" size="59" id="etat_proj" name="etat_proj" value="<?php echo $v_plan[1];?>"><div class="suggestionsBox" id="suggestions1" style="display: none;">
				<img src="upArrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
				<div class="suggestionList" id="autoSuggestionsList1">
					&nbsp;
				</div>
			</div></td></tr><tr><td>Points a evaluer
