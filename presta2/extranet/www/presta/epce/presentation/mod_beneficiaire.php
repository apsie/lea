...
{
$dat_naissance=date("dmy",$etat_civil[0]);
}
else
{
$dat_naissance=NULL;
...
if(isset($_GET['id_parcours_edit']))
{
	...
	if($parcours[8]!=0)
	{
	$date_debut_parcours = date("dmy",$parcours[8]);
	}
	if($parcours[9]!=0)
	{
	$date_fin_parcours = date("dmy",$parcours[9]);
	}
...
<br/>
      ...
      <td>Date immat</td>
      <td width="330" ><input name="date_immat"  type="text" value="<?php if($retour_org_ben[11]!=NULL) echo date("dmy",$retour_org_ben[11]); ?>"  id="date_immat"/> <script type="text/javascript">
	...
	Calendar.setup(
	{
      ...
      <td width="157" ><input name="date_debut_activite"  type="text" value="<?php if($retour_org_ben[12]!=NULL) echo date("dmy",$retour_org_ben[12]); ?>" id="date_debut_activite" /> <script type="text/javascript">
