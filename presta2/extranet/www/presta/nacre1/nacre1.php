...
<table width="616"><tr class="pourcent">
 ...
 <a href=""> <h2>3. Prévisionnel financier</h2> 
  ...
  </a><a onclick="window.open('../../../Projet1.1/details.php?domain=default&id_projet=<?php echo $id_projet_return; ?>','Projet','type=fullWindow,fullscreen,scrollbars=yes');" href="javascript::void(0)">Voir projet du bénéficiaire </a>
</div>