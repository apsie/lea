...
<table >
	<tr >
		...
		<td width="321"  align="left" ><?php $epce->selectionner_conseiller3($id_con); echo' a '; ?> <select name="lieu"><?php echo $val; ?><option value="Courbevoie">Courbevoie</option><option value="Gennevilliers">Gennevilliers</option><option value="Antony">Antony</option><option value="Boulogne">Boulogne</option><option value="Issy">Issy</option><option value="Melun">Melun</option><option value="Provins">Provins</option><option value="Meaux">Meaux</option><option value="Coulommiers">Coulommiers</option><option value="Montereau">Montereau</option><option value="Torcy">Torcy</option><option value="Epinay">Epinay</option><option value="Saint-Denis">Saint-Denis</option><option value="Vitry">Vitry</option><option value="Saint-Maur">Saint-Maur</option></select></td>
	</tr>
	<tr >
